inherited rptCountingItemsF: TrptCountingItemsF
  Left = 334
  Top = 97
  ...
  object qryCountingItems: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     CountingItems.StuffCode, StuffCoding.c_StuffName, Cou' +
        'ntingItems.StuffSize, CountingItems.StuffDiameter,'
      
        '                      CountingItems.StuffAlloy, CountingItems.St' +
        'uffGrade, CountingItems.ControlCode ,'
      
        '                      CountingItems.Count1Entity, CountingItems.' +
        'Count1Weight,'
      
        '                      CountingItems.Count2Entity, CountingItems.' +
        'Count2Weight,'
      
        '                      CountingItems.Count3Entity, CountingItems.' +
        'Count3Weight,'
      
        '                      CountingItems.Count2Entity - CountingItems' +
        '.Count1Entity AS DifferEntity,'
      
        '                      CountingItems.Count2Weight - CountingItems' +
        '.Count1Weight AS DifferWeight'
      ', Stores.c_StoreName ,CountingItems.StoreID , 0.0 AS Entity'
      ',StuffCoding.c_KeepPlace'
      ''
      ''
      'FROM         CountingItems INNER JOIN'
      
        '                      StuffCoding ON CountingItems.StuffCode = S' +
        'tuffCoding.c_StuffCode INNER JOIN'
      
        '                         Stores ON CountingItems.StoreID = Store' +
        's.n_StoreID '
      ''
      
        'WHERE     (CountingItems.StoreID = :StoreID) AND (CountingItems.' +
        'CountID = :CountID)'
      
        '         AND (StuffCoding.GroupID BETWEEN :GroupIDFrom AND :Grou' +
        'pIDTo)'
      '')
    Left = 128
    Top = 233
    ...
    object qryCountingItemsDifferEntity: TFMTBCDField
      Tag = 3
      DisplayLabel = #1578#1601#1575#1608#1578' '#1588#1605#1575#1585#1588' '#1605#1602#1583#1575#1585
      FieldName = 'DifferEntity'
      ReadOnly = True
      Precision = 38
    end
    object qryCountingItemsDifferWeight: TFMTBCDField
      Tag = 3
      DisplayLabel = #1578#1601#1575#1608#1578' '#1588#1605#1575#1585#1588' '#1608#1586#1606
      FieldName = 'DifferWeight'
      ReadOnly = True
      Precision = 38
    end
