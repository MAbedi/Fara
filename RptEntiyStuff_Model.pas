...
type
  TRptEntiyStuff_ModelF = class(Ttemplate2MDIF)
...
var
  RptEntiyStuff_ModelF: TRptEntiyStuff_ModelF;
...
procedure TRptEntiyStuff_ModelF.UpdateFilter;
begin
...
procedure TRptEntiyStuff_ModelF.actFilterExecute(Sender: TObject);
begin
  inherited;
...
procedure TRptEntiyStuff_ModelF.qryStoreAfterScroll(DataSet: TDataSet);
begin
  inherited;
  With qryEntity do begin
    Active:=False;
...
procedure TRptEntiyStuff_ModelF.FormShow(Sender: TObject);
begin
  inherited;
  myParams.Clear;
  actFilter.Execute;
...
procedure TRptEntiyStuff_ModelF.SBtnStoreIDClick(Sender: TObject);
var
  c:  String;
begin
  inherited;
...
procedure TRptEntiyStuff_ModelF.ppLabel11GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptEntiyStuff_ModelF.ppLabel3GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text:=GetPrintDate;
...
procedure TRptEntiyStuff_ModelF.ppSystemVariable1GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptEntiyStuff_ModelF.FormResize(Sender: TObject);
begin
  inherited;
  SetColSize(DBGrid1,1,True);
end;

procedure TRptEntiyStuff_ModelF.FormDestroy(Sender: TObject);
begin
  inherited;
  SaveColWidth(DBGrid1);
end;

procedure TRptEntiyStuff_ModelF.actsendtoexelExecute(Sender: TObject);
begin
  inherited;
  SendToExcel(qryEntity);
end;

procedure TRptEntiyStuff_ModelF.actPrintExecute(Sender: TObject);
begin
  inherited;
  ppReport1.Print;
end;

procedure TRptEntiyStuff_ModelF.ppLabel16GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptEntiyStuff_ModelF.actSearch_Execute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qryEntity);
end;

procedure TRptEntiyStuff_ModelF.actSortExecute(Sender: TObject);
begin
  inherited;
  sort2F.ShowSort(qryEntity);
end;

procedure TRptEntiyStuff_ModelF.FormCreate(Sender: TObject);
begin
  inherited;
  //mary
  ...
  with qryinit do begin
    ...
    Active:=True;
  //             < „ﬁœ«— ° Ê“‰ Ê »Â«Ì ﬂ· «’·Ì ‰„«Ì‘ ‘Êœ >
    DBGrid1.Columns[5].Visible:=FieldByName('Section1Visible').AsInteger=1;
    DBGrid1.Columns[6].Visible:=FieldByName('Section1Visible').AsInteger=1;
...
procedure TRptEntiyStuff_ModelF.DBGrid1MouseUp(Sender: TObject;
...
procedure TRptEntiyStuff_ModelF.qryEntityCalcFields(DataSet: TDataSet);
begin
  inherited;
  DataSet.FieldByName('_row').AsInteger:=IfThen(DataSet.RecNo<>-1,DataSet.RecNo,1);
end;

procedure TRptEntiyStuff_ModelF.qryEntityAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TRptEntiyStuff_ModelF.ppLabel1GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
