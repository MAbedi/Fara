inherited rptReciptListOnStuffCodeF: TrptReciptListOnStuffCodeF
  Left = 320
  Top = 203
  ...
  inherited Panel3: TPanel
    ...
    object SumGrid1: TSumGrid
      ...
      ShowZero = True
      FieldsName = 
        'entity;weight;UnitSellPrice;Price;RequestedEntity;RequestedWeigh' +
        't;'
    end
  end
  ...
  object qryStuffCoding: TADOQuery
    ...
    SQL.Strings = (
      ...
      'FROM         StuffCoding INNER JOIN'
        ...
        'eciptItems.StuffCode INNER JOIN'
      '                      Recipts ON '
      ''
      ...
      ''
        ...
        'WHERE     (ReciptItems.StuffCode BETWEEN :StuffCodeFrom AND :Stu' +
        'ffCodeTo) AND'
      '          (Recipts.ReciptType = :ReciptType)'
  ...
  object qryRecipt_Items: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     Recipts.ReciptNumber, Recipts.ReciptDate, Recipts.Per' +
        'sonID1, Customers.CustName, Recipts.AidNumber, Recipts.AidDate,'
      
        '                      ReciptItems.InputEntity + ReciptItems.Outp' +
        'utEntity AS Entity, ReciptItems.InputWeight + ReciptItems.Output' +
        'Weight AS Weight,'
      
        '                      ReciptItems.UnitSellPrice, ReciptItems.Tot' +
        'alInputPrice + ReciptItems.TotalOutputPrice AS Price, Recipts.St' +
        'oreID, Stores.c_StoreName,'
      
        '                      Recipts.ReciptID, ReciptItems.ReciptItemID' +
        ', Recipts.ReciptType, ReciptItems.StuffCode, StuffCoding.c_Stuff' +
        'Name'
      ', ReciptItems.ControlCode'
      
        ', ReciptItems.ServerID, ReciptItems.YearID, ReciptItems.Requeste' +
        'dEntity, ReciptItems.RequestedWeight'
      ', ReciptItems.ItemNote'
      ''
      'FROM         Stores RIGHT OUTER JOIN'
      
        '                      Recipts ON Stores.n_StoreID = Recipts.Stor' +
        'eID LEFT OUTER JOIN'
      
        '                      Customers ON Recipts.PersonID1 = Customers' +
        '.CustID RIGHT OUTER JOIN'
      '                      ReciptItems LEFT OUTER JOIN'
      
        '                      StuffCoding ON ReciptItems.StuffCode = Stu' +
        'ffCoding.c_StuffCode ON '
      
        '       Recipts.ReciptID = ReciptItems.ReciptID AND Recipts.Serve' +
        'rID = ReciptItems.ServerID AND Recipts.YearID = ReciptItems.Year' +
        'ID'
      ''
      ' INNER JOIN'
      ...
      ''
        ...
        '     (Recipts.ReciptNumber BETWEEN :ReciptNumberFrom AND :Recipt' +
        'NumberTo) AND'
      
        '          (ReciptItems.StuffCode BETWEEN :StuffCodeFrom AND :Stu' +
        'ffCodeTo) AND'
      ''
      ...
      ''
        ...
        '          (Recipts.ReciptDate BETWEEN :ReciptDateFrom AND :Recip' +
        'tDateTo) AND'
    ...
    object qryRecipt_ItemsControlCode: TLargeintField
    ...
    object qryRecipt_ItemsRequestedEntity: TFloatField
      FieldName = 'RequestedEntity'
    end
    object qryRecipt_ItemsRequestedWeight: TFloatField
      FieldName = 'RequestedWeight'
    end
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\Projects\Fara\BSell\Exe\Report\rptReciptListOnStuffCode.rtm'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object TppLabel
        ...
        UserName = 'Label15'
        Border.mmPadding = 0
        Caption = #1603#1583' '#1608' '#1588#1585#1581' '#1603#1575#1604#1575':'#8207
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Yagut'
        Font.Size = 10
      ...
      object TppLabel
        ...
        UserName = 'Label16'
        Border.mmPadding = 0
        Caption = #1588#1605#1575#1585#1607#8207#1585#1575#1607#1606#1605#1575
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Yagut'
        Font.Size = 10
