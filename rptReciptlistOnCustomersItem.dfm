inherited rptReciptListOnCustomersItemF: TrptReciptListOnCustomersItemF
  Left = 370
  Top = 197
  Caption = #1711#1586#1575#1585#1588' '#1575#1591#1604#1575#1593#1575#1578
  ClientHeight = 517
  OnResize = FormResize
  ExplicitWidth = 794
  TextHeight = 13
  ...
  inherited Panel3: TPanel
    ...
    object SumGrid1: TSumGrid
      ...
      MasterGrid = DBGrid1
      ShowZero = True
      FieldsName = 'entity;weight;UnitSellPrice;Price;'
    end
  end
  ...
  object srcRecipt_Items: TDataSource
    DataSet = qryRecipt_Items
    Left = 112
    Top = 244
  end
  object qryCustomers: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT DISTINCT ReciptItems.PersonID1, CASE WHEN Customers.CustN' +
        'ame LIKE N'#39'%'#39'+ ISNULL(Customers.CustFirstName, '#39#39') +'#39'%'#39' THEN Cus' +
        'tomers.CustName'
      
        ' ELSE Customers.CustName + '#39' '#39' + ISNULL(Customers.CustFirstName,' +
        ' '#39#39') END AS CustName'
      'FROM         Customers RIGHT OUTER JOIN'
      
        '                      ReciptItems ON Customers.CustID = ReciptIt' +
        'ems.PersonID1 RIGHT OUTER JOIN'
      
        '                      Recipts ON ReciptItems.YearID = Recipts.Ye' +
        'arID AND ReciptItems.ServerID = Recipts.ServerID AND ReciptItems' +
        '.ReciptID = Recipts.ReciptID'
      
        'WHERE     (Customers.CustomerGrpID BETWEEN  :CustomerGrpIDFrom A' +
        'ND :CustomerGrpIDTo)'
      
        ' AND (Recipts.ReciptType  = :ReciptType ) AND (ReciptItems.Perso' +
        'nID1 BETWEEN  :PersonID1From AND :PersonID1To )')
    Left = 168
    Top = 84
  ...
  object qryRecipt_Items: TADOQuery
    Connection = DmF.adcBSell
    CursorType = ctStatic
    LockType = ltReadOnly
    Parameters = <
    ...
    SQL.Strings = (
        ...
        'SELECT  Recipts.ReciptNumber, Recipts.ReciptDate, ReciptItems.St' +
        'uffCode, StuffCoding.c_StuffName, Units.UnitName, Recipts.AidNum' +
        'ber, Recipts.AidDate,'
      
        '        ReciptItems.InputEntity + ReciptItems.OutputEntity AS En' +
        'tity, ReciptItems.InputWeight + ReciptItems.OutputWeight AS Weig' +
        'ht,'
      
        '        ReciptItems.UnitSellPrice, ReciptItems.TotalInputPrice +' +
        ' ReciptItems.TotalOutputPrice AS Price, Recipts.StoreID, Stores.' +
        'c_StoreName,'
      
        '        Recipts.ReciptID, ReciptItems.ReciptItemID, Recipts.Reci' +
        'ptType, ReciptItems.PersonID1, Customers.CustName, Customers.Cus' +
        'tomerGrpID,'
      
        '        CustomersGroup.CustomerGrpName, ReciptItems.ServerID, Re' +
        'ciptItems.YearID, ReciptItems.ItemNote'
      ''
      'FROM         Customers RIGHT OUTER JOIN'
      ...
      '                      Units INNER JOIN'
      '                      StuffCoding INNER JOIN'
      
        '                      ReciptItems ON StuffCoding.c_StuffCode = R' +
        'eciptItems.StuffCode ON Units.UnitCode = StuffCoding.n_UnitCode ' +
        'ON '
      
        '                      Customers.CustID = ReciptItems.PersonID1 R' +
        'IGHT OUTER JOIN'
      '                      Stores INNER JOIN'
      
        '                      Recipts ON Stores.n_StoreID = Recipts.Stor' +
        'eID ON ReciptItems.YearID = Recipts.YearID AND ReciptItems.Serve' +
        'rID = Recipts.ServerID AND '
      '                      ReciptItems.ReciptID = Recipts.ReciptID'
      ''
      ''
      ''
      ' INNER JOIN'
      ...
      ''
        ...
        '       (Recipts.ReciptNumber BETWEEN :ReciptNumberFrom AND :Reci' +
        'ptNumberTo) AND'
      
        '       (ReciptItems.StuffCode BETWEEN :StuffCodeFrom AND :StuffC' +
        'odeTo) AND'
      
        '       (Recipts.StoreID BETWEEN :StoreIDFrom AND  :StoreIDTo) AN' +
        'D'
      
        '       (Recipts.ReciptDate BETWEEN :ReciptDateFrom AND :ReciptDa' +
        'teTo) AND'
      
        '       (Customers.CustomerGrpID BETWEEN :CustomerGrpIDFrom AND :' +
        'CustomerGrpIDTo) AND'
      
        '       (ReciptItems.PersonID1 BETWEEN :PersonID1From AND :Person' +
        'ID1To) and'
    ...
    Left = 216
    Top = 233
    object qryRecipt_ItemsReciptNumber: TIntegerField
      Tag = 3
      DisplayLabel = #1588#1605#1575#1585#1607' '#1601#1585#1605
      FieldName = 'ReciptNumber'
    end
    object qryRecipt_ItemsReciptDate: TStringField
      Tag = 3
    ...
    object qryRecipt_ItemsStuffCode: TLargeintField
      Tag = 3
      DisplayLabel = #1603#1583' '#1603#1575#1604#1575
      FieldName = 'StuffCode'
    end
    object qryRecipt_Itemsc_StuffName: TStringField
      Tag = 3
      DisplayLabel = #1606#1575#1605' '#1603#1575#1604#1575
      FieldName = 'c_StuffName'
      Size = 255
    end
    object qryRecipt_ItemsAidNumber: TStringField
      FieldName = 'AidNumber'
      Size = 40
    end
    object qryRecipt_ItemsAidDate: TStringField
      Tag = 3
      FieldName = 'AidDate'
      FixedChar = True
      Size = 10
    end
    object qryRecipt_Itemsentity: TFloatField
      Tag = 3
      DisplayLabel = #1605#1602#1583#1575#1585
      FieldName = 'entity'
    end
    object qryRecipt_Itemsweight: TFloatField
      Tag = 3
      DisplayLabel = #1608#1586#1606
      FieldName = 'weight'
    end
    object qryRecipt_ItemsUnitSellPrice: TFMTBCDField
      Tag = 3
    ...
    object qryRecipt_ItemsPrice: TBCDField
      Tag = 3
    ...
    object qryRecipt_ItemsItemNote: TStringField
      Tag = 3
      DisplayLabel = #1578#1608#1590#1610#1581#1575#1578' '#1603#1575#1604#1575
      FieldName = 'ItemNote'
      Size = 100
    end
    object qryRecipt_ItemsStoreID: TSmallintField
      DisplayLabel = #1603#1583' '#1575#1606#1576#1575#1585
      FieldName = 'StoreID'
    end
    object qryRecipt_Itemsc_StoreName: TStringField
      Tag = 3
      DisplayLabel = #1606#1575#1605' '#1575#1606#1576#1575#1585
      FieldName = 'c_StoreName'
      Size = 70
    end
    object qryRecipt_ItemsReciptID: TIntegerField
      DisplayLabel = #1588#1605#1575#1585#1606#1583#1607
      FieldName = 'ReciptID'
    end
    object qryRecipt_ItemsReciptType: TIntegerField
      DisplayLabel = #1603#1583' '#1575#1591#1604#1575#1593#1575#1578
      FieldName = 'ReciptType'
    end
    object qryRecipt_ItemsReciptItemID: TIntegerField
      FieldName = 'ReciptItemID'
    end
    object qryRecipt_ItemsPersonID1: TIntegerField
      DisplayLabel = #1603#1583' '#1605#1588#1578#1585#1610
      FieldName = 'PersonID1'
    end
    object qryRecipt_ItemsCustName: TStringField
      DisplayLabel = #1606#1575#1605' '#1605#1588#1578#1585#1610
      FieldName = 'CustName'
      Size = 120
    end
    object qryRecipt_ItemsServerID: TIntegerField
      FieldName = 'ServerID'
    end
    object qryRecipt_ItemsYearID: TIntegerField
      FieldName = 'YearID'
    end
  end
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\Projects\Fara\BSell\Exe\Report\rptReciptListOnCustomers.rtm'
