inherited RptEntityStuffGrpAllStoreF: TRptEntityStuffGrpAllStoreF
  Left = 422
  Top = 303
  Caption = #1711#1586#1575#1585#1588' '#1605#1608#1580#1608#1583#1610' '#1576#1585' '#1581#1587#1576' '#1711#1585#1608#1607' '#1603#1575#1604#1575'('#1607#1605#1607' '#1575#1606#1576#1575#1585#1607#1575#8204')'#8207
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited Panel2: TPanel
    inherited lblCaption: TLabel
      Left = 447
      Width = 293
      Caption = #1603#1586#1575#1585#1588' '#1605#1608#1580#1608#1583#1610' '#1576#1585' '#1581#1587#1576' '#1711#1585#1608#1607' '#1603#1575#1604#1575'('#1607#1605#1607' '#1575#1606#1576#1575#1585#1607#1575#8204')'#8207
      ExplicitLeft = 447
      ExplicitWidth = 293
    end
  end
  ...
  object qryEntity: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     StuffCoding.GroupID, StuffGroups.GroupName,Round(SUM(' +
        'R.InputEntity - R.OutputEntity),3)'
      
        '                      AS Entity,Round(SUM(R.InputWeight - R.Outp' +
        'utWeight),3) AS Weight,'
      
        '                      SUM(R.TotalInputPrice - R.TotalOutputPrice' +
        ') AS Price,'
      '       SUM(R.TotallSellPrice ) AS TotallSellPrice'
      'FROM      ReciptItems_Stock R'
      ' INNER JOIN'
      
        '                      StuffCoding ON R.StuffCode = StuffCoding.c' +
        '_StuffCode INNER JOIN'
      
        '                      StuffGroups ON StuffCoding.GroupID = Stuff' +
        'Groups.GroupID'
      ''
      'WHERE   R.StoreID in('
      'SELECT DISTINCT n_StoreID'
      'FROM         UsersStore'
      'WHERE     (n_UserID = :UserID) OR'
      '                      (:UserIDAdmin = 127))AND'
      ''
      ''
      ...
      'and'
      'R.yearID between :YearIDFrom And :YearIDTO'
      ''
      ' AND (StuffCoding.OwnerShipKind  in (:StuffKindActive))'
      'AND (R.PersonID1D BETWEEN :PersonID1DFrom AND :PersonID1DTo)'
      ''
      ''
      'GROUP BY StuffCoding.GroupID, StuffGroups.GroupName'
      'HAVING  (SUM(R.InputEntity - R.OutputEntity) >= 0.0001 OR'
      '         SUM(R.InputEntity - R.OutputEntity) <= - 0.0001) OR'
      '        (SUM(R.InputWeight - R.OutputWeight) >= 0.0001) OR'
      '        (SUM(R.InputWeight - R.OutputWeight) <= - 0.0001) OR'
      '        (SUM(R.TotalInputPrice - R.TotalOutputPrice) >= 0.1) OR'
      '        (SUM(R.TotalInputPrice - R.TotalOutputPrice) <= - 0.1)'
      'OR SUM(R.InputEntity - R.OutputEntity)=0')
    Left = 400
    Top = 104
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\Projects\Fara\BSell\Exe\Report\RptEntityStuffGrpAllStore.rtm'
