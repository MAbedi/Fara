{ -----------------------------------------------------------------------------
  Unit Name: rptCompare_Count_EntityD
  Author:    Mahmood
  ----------------------------------------------------------------------------- }
unit rptCompare_Count_EntityD;
...
type
  ...
  TrptCompare_Count_EntityDF = class(Ttemplate2MDIF)
    ...
    qryCountingItemsPrice: TBCDField;
    qryCountingItemsDifferPrice: TFloatField;
    qryCountingItemsTotallSellPrice: TBCDField;
    qryCountingItemsDifferTotallSellPrice: TFloatField;
    qryCountingItemsOtherPrice: TFloatField;
    qryCountingItemsOtherTotallSellPrice: TFloatField;
    ...
    qryCountingItemsSellPrice1: TBCDField;
    ...
    qryCountingItemsCountEntity: TFMTBCDField;
...
var
  rptCompare_Count_EntityDF: TrptCompare_Count_EntityDF;
...
procedure TrptCompare_Count_EntityDF.actSendExelExecute(Sender: TObject);
begin
  inherited;
  SendToExcel(DBGrid1);
end;

procedure TrptCompare_Count_EntityDF.qryCountingAfterScroll(DataSet: TDataSet);
begin
  inherited;
...
procedure TrptCompare_Count_EntityDF.FormCreate(Sender: TObject);
begin
  inherited;
...
//  qryCountingItems.FieldByName('TotallSellPrice').Visible := opt.ActiveSellPrice2;
//  qryCountingItems.FieldByName('DifferTotallSellPrice').Visible := opt.ActiveSellPrice2;
//  qryCountingItems.FieldByName('OtherTotallSellPrice').Visible := opt.ActiveSellPrice2;
    HideOrShowSellPriceFields(qryCountingItems,DBGrid1);


  qryCountingItems.FieldByName('c_StuffTecInfo').Visible := opt.StuffTecInfoActive;
...
procedure TrptCompare_Count_EntityDF.actPrintExecute(Sender: TObject);
begin
  inherited;
  PopMenu.Popup(Mouse.CursorPos.X, Mouse.CursorPos.Y);
end;

procedure TrptCompare_Count_EntityDF.ppLblCompanyNameGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TrptCompare_Count_EntityDF.actSearch_Execute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qryCountingItems);
end;

procedure TrptCompare_Count_EntityDF.actSortExecute(Sender: TObject);
begin
  inherited;
  sort2F.ShowSort(qryCountingItems);
end;

procedure TrptCompare_Count_EntityDF.AllC_l_i_c_k_Click(Sender: TObject);
var
  s: String;
begin
  inherited;
  ...
  try
    qryCounting.DisableControls;
    qryCountingItems.DisableControls;
    InitReportFile(ppReport1, 'rptCompare_Count_EntityD' + s);
  finally
    qryCounting.EnableControls;
    qryCountingItems.EnableControls;
  end; // try
...
procedure TrptCompare_Count_EntityDF.btnCountNumberClick(Sender: TObject);
var
  Txt: String;
  b: Boolean;
...
procedure TrptCompare_Count_EntityDF.chkNoCountingItemsClick(Sender: TObject);
begin
  inherited;
  qryCountingAfterScroll(qryCounting)
end;

procedure TrptCompare_Count_EntityDF.BitBtn1Click(Sender: TObject);
begin
  inherited;
  DBGrid2PrintF.showGrid2Print(DBGrid1, 0);
end;

procedure TrptCompare_Count_EntityDF.ppSysVarPageNoGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TrptCompare_Count_EntityDF.ppLblPrintDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := GetPrintDate;
...
procedure TrptCompare_Count_EntityDF.CmbEffectType2Change(Sender: TObject);
var
  Txt: String;
  formType: Byte;
begin
...
procedure TrptCompare_Count_EntityDF.BitBtn15Click(Sender: TObject);
var
  IOEntity: String;
  ReciptID: Integer;
begin
    ...
    begin
      ...
      begin
        ...
        qryItems.FieldByName('Total' + IOEntity + 'Price').AsCurrency :=
          abs(FieldByName('OtherPrice').AsCurrency); // UnitSellPrice
...
procedure TrptCompare_Count_EntityDF.qryItemsAfterInsert(DataSet: TDataSet);
begin
  inherited;
  GetANewID(DataSet, Self.Name, 'ReciptItems', 'ReciptItemID', nil, 1);
end;

procedure TrptCompare_Count_EntityDF.BitBtn2Click(Sender: TObject);
begin
  inherited;
