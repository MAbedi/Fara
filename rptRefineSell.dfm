inherited rptRefineSellF: TrptRefineSellF
  Left = 388
  Top = 187
  Caption = 'rptRefineSellF'
  ExplicitTop = -21
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object SrcRefineSell: TDataSource
    DataSet = qryRefineSell
    Left = 320
    Top = 145
  end
  object qryRefineSell: TADOQuery
    Connection = DmF.adcBSell
    CursorType = ctStatic
    LockType = ltReadOnly
    AfterOpen = qryRefineSellAfterOpen
    Parameters = <>
    Left = 184
    Top = 137
  end
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\Projects\Fara\BSell\Exe\Report\rptRefineSell9.rtm'
