inherited SellersF: TSellersF
  Left = 311
  Top = 150
  ActiveControl = cmbGroups
  Caption = #1605#1593#1585#1601#1610' '#1601#1585#1608#1588#1606#1583#1607
  ClientHeight = 719
  ClientWidth = 1024
  OnResize = FormResize
  ExplicitWidth = 1032
  ...
  inherited Panel3: TPanel
    ...
    object Panel4: TPanel
      ...
      object Label32: TLabel
        ...
        FocusControl = edtAccountNumber1
      end
      ...
      object PageControl1: TPageControl
        ...
        object TabSheet5: TTabSheet
          ...
          object Label2: TLabel
            ...
            Height = 13
            Anchors = [akTop, akRight]
            Caption = #1606#1575#1605' '#1605#1583#1740#1585' '#1575#1589#1604#1740
            FocusControl = edtManageName1
          end
        ...
        object TabSheet8: TTabSheet
          ...
          object Label50: TLabel
            ...
            FocusControl = edtCustAccountNumber1
          end
          ...
          object edtCustAccountNumber1: TDBEdit
            Left = 10
            Top = 28
            Width = 209
            Height = 21
          ...
          object DBGrid2: TDBGrid
            ...
            Anchors = [akLeft, akTop, akRight, akBottom]
            Color = clCream
            DataSource = srcCustomersAccount
            Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgAlwaysShowSelection, dgConfirmDelete, dgCancelOnExit]
            TabOrder = 5
            TitleFont.Charset = DEFAULT_CHARSET
            TitleFont.Color = clWindowText
        ...
        object TabSheet7: TTabSheet
          ...
          object DBGrid3: TDBGrid
            ...
            Align = alClient
            Color = clCream
            DataSource = srcCustomerLookUpInfo
            Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgAlwaysShowSelection, dgConfirmDelete, dgCancelOnExit]
            TabOrder = 0
            TitleFont.Charset = DEFAULT_CHARSET
            TitleFont.Color = clWindowText
      ...
      object edtAccountNumber1: TDBEdit
        Left = 15
        Top = 261
        Width = 196
        Height = 21
  ...
  object qryCustomersAccount: TADOQuery
    Connection = DmF.adcBSell
    CursorType = ctStatic
    AfterInsert = qryCustomersAccountAfterInsert
    Parameters = <
      item
        Name = 'CustID'
        Attributes = [paSigned]
    ...
    Left = 168
    Top = 491
    object qryCustomersAccountID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object qryCustomersAccountCustID: TIntegerField
      FieldName = 'CustID'
    end
    object qryCustomersAccountAccountNumber: TStringField
      DisplayLabel = #1588#1605#1575#1585#1607' '#1581#1587#1575#1576
      FieldName = 'AccountNumber'
      FixedChar = True
      Size = 25
    end
    object qryCustomersAccountBankName: TStringField
      DisplayLabel = #1606#1575#1605' '#1576#1575#1606#1705
      FieldName = 'BankName'
      Size = 60
    end
    object qryCustomersAccountBranchCode: TStringField
      DisplayLabel = #1705#1583' '#1588#1593#1576#1607
      FieldName = 'BranchCode'
      FixedChar = True
      Size = 25
    end
    object qryCustomersAccountAccountKind: TIntegerField
      DisplayLabel = #1606#1608#1593' '#1581#1587#1575#1576' '#1576#1575#1606#1603#1610
      FieldName = 'AccountKind'
    end
    object qryCustomersAccount_AccountKind: TStringField
      DisplayLabel = #1606#1608#1593' '#1581#1587#1575#1576' '#1576#1575#1606#1603#1610
      FieldKind = fkLookup
      FieldName = '_AccountKind'
      LookupDataSet = DmF.qryCurrencies
    ...
    object qryCustomersAccountAccountHolderName: TStringField
      DisplayLabel = #1606#1575#1605' '#1589#1575#1581#1576' '#1581#1587#1575#1576
      FieldName = 'AccountHolderName'
      Size = 60
    end
    object qryCustomersAccountIbanNumber: TStringField
      DisplayLabel = #1588#1605#1575#1585#1607' '#1581#1587#1575#1576' '#1588#1576#1575
      FieldName = 'IbanNumber'
      Size = 60
    end
    object qryCustomersAccountBankIDc: TStringField
      DisplayLabel = #1588#1606#1575#1587#1607' '#1576#1575#1606#1705' '#1591#1576#1602' '#1580#1583#1608#1604' '#1591#1585#1581' '#1662#1585#1583#1575#1582#1578' '#1607#1605#1575#1607#1606#1711' '#1602#1576#1608#1590
      FieldName = 'BankIDc'
      FixedChar = True
      Size = 3
    end
  end
  object srcCustomersAccount: TDataSource
    DataSet = qryCustomersAccount
    OnStateChange = srcCustomersAccountStateChange
    Left = 344
    Top = 496
  end
  object qryCustomerLookUpInfo: TADOQuery
    Connection = DmF.adcBSell
    CursorType = ctStatic
    AfterInsert = qryCustomerLookUpInfoAfterInsert
    BeforePost = qryCustomerLookUpInfoBeforePost
    AfterPost = qryCustomerLookUpInfoAfterPost
    AfterScroll = qryCustomerLookUpInfoAfterScroll
    Parameters = <
      item
        Name = 'CustID'
        DataType = ftWideString
    ...
    SQL.Strings = (
      '  SELECT     CustID, LookUpID, LookUpItemID'
      'FROM CustomerLookUpInfo'
      'WHERE     (CustID = :CustID)')
    Left = 388
    Top = 350
    object qryCustomerLookUpInfoCustID: TIntegerField
      FieldName = 'CustID'
    end
    object qryCustomerLookUpInfoLookUpID: TIntegerField
      FieldName = 'LookUpID'
      OnChange = qryCustomerLookUpInfoLookUpIDChange
    end
    object qryCustomerLookUpInfo_LookUpID: TStringField
    ...
    object qryCustomerLookUpInfoLookUpItemID: TIntegerField
      FieldName = 'LookUpItemID'
    end
    object qryCustomerLookUpInfo_LookUpItemID: TStringField
      ...
      LookupKeyFields = 'LookUpID'
      LookupResultField = 'Name'
      KeyFields = 'LookUpItemID'
      Size = 200
      Lookup = True
    end
  end
  object srcCustomerLookUpInfo: TDataSource
    DataSet = qryCustomerLookUpInfo
    Left = 580
    Top = 320
  end
