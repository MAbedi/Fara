{ -----------------------------------------------------------------------------
  ...
  Author:    Mahmood
  ----------------------------------------------------------------------------- }
unit rptReciptSumOnCustomersItem;
...
type
  TrptReciptSumOnCustomersItemF = class(Ttemplate2MDIF)
...
var
  rptReciptSumOnCustomersItemF: TrptReciptSumOnCustomersItemF;
...
procedure TrptReciptSumOnCustomersItemF.UpdateFilter;
begin
...
procedure TrptReciptSumOnCustomersItemF.actFilterExecute(Sender: TObject);
var
  fi: TfilterF;
begin
  inherited;
  ...
  begin
    try
      AddItem(DMf.adcBSell, 'PersonID1', '„‘ —Ì ¬Ì „', 'ﬂœ', ftInteger,
        ...
        ')GROUP BY Customers.CustID,Customers.CustFirstName, Customers.CustName',
...
procedure TrptReciptSumOnCustomersItemF.FormShow(Sender: TObject);
begin
  inherited;
  myParams.Clear;
  actFilter.Execute;
...
procedure TrptReciptSumOnCustomersItemF.FormResize(Sender: TObject);
begin
  inherited;
  SetColSize(DBGrid1, 1, True, Self.Name + formType);
end;

procedure TrptReciptSumOnCustomersItemF.FormDestroy(Sender: TObject);
begin
  inherited;
  SaveColWidth(DBGrid1, Self.Name + formType);
end;

procedure TrptReciptSumOnCustomersItemF.actSendExelExecute(Sender: TObject);
begin
  inherited;
  SendToExcel(DBGrid1);
end;

procedure TrptReciptSumOnCustomersItemF.qryCustomersAfterScroll
  (DataSet: TDataSet);
begin
  inherited;
  with qryRecipt_Items do
...
procedure TrptReciptSumOnCustomersItemF.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TrptReciptSumOnCustomersItemF.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TrptReciptSumOnCustomersItemF.actShowFormExecute(Sender: TObject);
begin
  inherited;
  ShowReciptTypes(qryRecipt_Items, Self)
end;

procedure TrptReciptSumOnCustomersItemF.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
  actShowForm.Execute
end;

procedure TrptReciptSumOnCustomersItemF.ppSysVarPageNumberGetText
...
procedure TrptReciptSumOnCustomersItemF.ppLblPrintDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := GetPrintDate
...
procedure TrptReciptSumOnCustomersItemF.ppLblCompanyNameGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TrptReciptSumOnCustomersItemF.ppLblDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TrptReciptSumOnCustomersItemF.SpeedButton1Click(Sender: TObject);
var
  b: Boolean;
...
procedure TrptReciptSumOnCustomersItemF.EdtPersonID1KeyDown(Sender: TObject;
...
procedure TrptReciptSumOnCustomersItemF.actSearch_Execute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qryRecipt_Items);
end;

procedure TrptReciptSumOnCustomersItemF.actSortExecute(Sender: TObject);
begin
  inherited;
  sort2F.ShowSort(qryRecipt_Items);
end;

procedure TrptReciptSumOnCustomersItemF.actshowChartExecute(Sender: TObject);
begin
  inherited;
  TreeChartF.showChart(qryRecipt_Items, Self, LblLimit.Caption);
end;

procedure TrptReciptSumOnCustomersItemF.actPrintExecute(Sender: TObject);
begin
  inherited;
  try
    qryCustomers.DisableControls;
    qryRecipt_Items.DisableControls;
    InitReportFile(ppReport1, 'rptReciptSumOnCustomersItem', True);
  finally
...
procedure TrptReciptSumOnCustomersItemF.actPrintVijehExecute(Sender: TObject);
begin
  inherited;
  DBGrid2PrintF.showGrid2Print(DBGrid1, 0);
end;

procedure TrptReciptSumOnCustomersItemF.ppLblCaptionGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := Caption;
