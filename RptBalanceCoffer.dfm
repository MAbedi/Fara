inherited rptBalanceCofferF: TrptBalanceCofferF
  Left = 417
  Top = 188
  ...
  inherited Panel2: TPanel
    ...
    object Label1: TLabel
      ...
      Caption = #1605#1581#1583#1608#1583#1607' '#1603#1583' '
      ExplicitLeft = 678
    end
  ...
  object srcBalanceCoffer: TDataSource
    DataSet = qrytBalanceCoffer
    Left = 200
    Top = 8
  end
  object qrytBalanceCoffer: TADOQuery
    ...
    SQL.Strings = (
      'select customerid1 as CustID , Vu_CustomersGroups.CustName ,'
      ''
      
        'sum(case when kind = 0 then bed - bes else 0 end ) as FirstBalan' +
        'ce ,'
      'sum(case when kind <> 0 then bed else 0 end ) as bed  ,'
      'sum(case when kind <> 0 then bes else 0 end ) as bes ,'
      'sum(bed  - bes ) as Balance,Vu_CustomersGroups.AccountNumber'
      ',Vu_CustomersGroups.BankId,Vu_CustomersGroups.BankName,'
      ''
      
        'sum(case when kind = 0 then Arzbed - Arzbes else 0 end ) as ArzF' +
        'irstBalance ,'
      'sum(case when kind <> 0 then Arzbed else 0 end ) as Arzbed  ,'
      'sum(case when kind <> 0 then Arzbes else 0 end ) as Arzbes ,'
      'sum(Arzbed  - Arzbes ) as ArzBalance'
      ''
      ''
      ''
      'FROM'#9'Vu_CustomersGroups INNER JOIN'
      
        #9#9'dbo.allaccount(1,2,10,-1,  :CustFrom , :CustTo , :DateFrom, :D' +
        'ateTo , :DateFromRemain , :YearIDFrom   , :YearIDTo'
      
        '    , :SellsMethodFrom , :SellsMethodTo , :SellsEmporiumFrom ,  ' +
        ':SellsEmporiumTo , DEFAULT )allaccount  ON Vu_CustomersGroups.Cu' +
        'stID = allaccount.customerid1'
      ''
      'WHERE     (Vu_CustomersGroups.GroupType IN (  :GroupType ))'
      
        ' AND ( ISNULL(allaccount.ArzTypeID,0) BetWeen :ArzTypeIDFrom AND' +
        ' :ArzTypeIDTo)'
      ''
      
        'group by customerid1  , Vu_CustomersGroups.CustName,Vu_Customers' +
    ...
    Left = 280
    Top = 143
    object qrytBalanceCofferCustID: TIntegerField
      Tag = 3
      DisplayLabel = #1603#1583
      FieldName = 'CustID'
    end
    object qrytBalanceCofferCustName: TStringField
      Tag = 3
      DisplayLabel = #1593#1606#1608#1575#1606' '#1581#1587#1575#1576'  /'#1589#1606#1583#1608#1602#1583#1575#1585
      FieldName = 'CustName'
      Size = 120
    end
    object qrytBalanceCofferArzFirstBalance: TFloatField
      DisplayLabel = #1605#1575#1606#1583#1607' '#1575#1586' '#1602#1576#1604' '#1575#1585#1586
      FieldName = 'ArzFirstBalance'
      ReadOnly = True
    end
    object qrytBalanceCofferArzbed: TFloatField
      DisplayLabel = #1583#1585#1610#1575#1601#1578#1610' / '#1608#1589#1608#1604#1610' '#1575#1585#1586
      FieldName = 'Arzbed'
      ReadOnly = True
    end
    object qrytBalanceCofferArzbes: TFloatField
      DisplayLabel = #1662#1585#1583#1575#1582#1578#1610' '#1575#1585#1586
      FieldName = 'Arzbes'
      ReadOnly = True
    end
    object qrytBalanceCofferArzBalance: TFloatField
      DisplayLabel = #1605#1575#1606#1583#1607' '#1575#1585#1586
      FieldName = 'ArzBalance'
      ReadOnly = True
    end
    object qrytBalanceCofferfirstBalance: TBCDField
      Tag = 3
      Alignment = taLeftJustify
      DisplayLabel = #1605#1575#1606#1583#1607' '#1575#1586' '#1602#1576#1604
      FieldName = 'firstBalance'
      currency = True
      Precision = 19
    end
    object qrytBalanceCofferbed: TBCDField
      Tag = 3
      Alignment = taLeftJustify
      DisplayLabel = #1583#1585#1610#1575#1601#1578#1610' / '#1608#1589#1608#1604#1610
      FieldName = 'bed'
      currency = True
      Precision = 19
    end
    object qrytBalanceCofferbes: TBCDField
      Tag = 3
      Alignment = taLeftJustify
      DisplayLabel = #1662#1585#1583#1575#1582#1578#1610
      FieldName = 'bes'
      currency = True
      Precision = 19
    end
    object qrytBalanceCofferBalance: TBCDField
      Tag = 3
      Alignment = taLeftJustify
    ...
    object qrytBalanceCofferAccountNumber: TStringField
      Tag = 3
    ...
    object qrytBalanceCofferBankId: TFloatField
      Tag = 3
      DisplayLabel = #1705#1583#1588#1593#1576#1607
      FieldName = 'BankId'
    end
    object qrytBalanceCofferBankName: TStringField
      Tag = 3
  ...
  object ppReport1: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel2: TppLabel
        ...
        UserName = 'Label2'
        Border.mmPadding = 0
        Caption = #1711#1586#1575#1585#1588' '#1578#1585#1575#1586' '#1593#1605#1604#1603#1585#1583' '#1576#1575#1606#1603#1607#1575' '#1608' '#1589#1606#1583#1608#1602' '
        Font.Charset = ARABIC_CHARSET
        Font.Color = clBlack
        Font.Name = 'Yagut'
        Font.Size = 12
      ...
      object ppLabel7: TppLabel
        ...
        UserName = 'Label7'
        Border.mmPadding = 0
        Caption = #1583#1585#1610#1575#1601#1578#1610' / '#1608#1589#1608#1604#1610' '
        Font.Charset = ARABIC_CHARSET
        Font.Color = clBlack
        Font.Name = 'Zar'
        Font.Size = 10
