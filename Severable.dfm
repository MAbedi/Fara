inherited SeverableF: TSeverableF
  Left = 560
  Top = 222
  Caption = #1605#1576#1575#1604#1594' '#1578#1601#1705#1740#1705#1740
  ClientHeight = 432
  ClientWidth = 680
  OldCreateOrder = True
  ExplicitWidth = 686
  ...
  inherited Panel1: TPanel
    ...
    inherited lblTopic0: TLabel
      Left = 536
      Width = 70
      Caption = #1605#1576#1575#1604#1594' '#1578#1601#1603#1610#1603#1610
      ExplicitLeft = 477
      ExplicitWidth = 70
    end
  ...
  object Panel2: TPanel [3]
    ...
    object Panel4: TPanel
      ...
      object pnlTopicCodeDetails: TPanel
        ...
        object edt_TopicCodeName_L1: TDBEdit
          AlignWithMargins = True
          Left = 3
          Top = 3
          Width = 160
      ...
      object pnlDetailCodeDetail: TPanel
        ...
        object edt_DetailsName_L1: TDBEdit
          AlignWithMargins = True
          Left = 3
          Top = 3
          Width = 163
    ...
    object pnlCTopicCode2Detail: TPanel
      ...
      object pnlCTopicCode3Detail: TPanel
        ...
        object edt_CTopicCode3: TDBEdit
          AlignWithMargins = True
          Left = 3
          Top = 3
          Width = 163
      ...
      object edt_CTopicName2_L1: TDBEdit
        AlignWithMargins = True
        Left = 235
        Top = 3
        Width = 163
      ...
      object pnlCTopicCode1Detail: TPanel
        ...
        object edt_CTopicName_L1: TDBEdit
          AlignWithMargins = True
          Left = 3
          Top = 3
          Width = 163
  ...
  object pnl1: TPanel [4]
    ...
    object EdtCheckNumber: TDBEdit
      ...
      DataSource = dsFormItems
      ParentCtl3D = False
      TabOrder = 2
    end
    object dbedtCheckDate: TDBEdit
      Left = 14
      Top = 47
      Width = 70
      Height = 19
    ...
    object dbedtItemAmount: TDBEdit
      Left = 499
      Top = 25
      Width = 110
      Height = 19
  ...
  object qrySeverable: TADOQuery
    ...
    CursorType = ctStatic
    AfterInsert = qrySeverableAfterInsert
    BeforePost = qrySeverableBeforePost
    AfterPost = qrySeverableAfterPost
    BeforeDelete = qrySeverableBeforeDelete
    AfterDelete = qrySeverableAfterDelete
    Parameters = <
      item
        Name = 'FormItemID'
        Attributes = [paSigned]
    ...
    object qrySeverable_Cudtomername2: TStringField
    ...
    object qrySeverableCTopicCode3: TStringField
      DisplayLabel = #1603#1583' '#1578#1601#1589#1610#1604#1610'4'
      FieldName = 'CTopicCode3'
      Size = 12
    end
    object qrySeverable_CTopicCode3: TStringField
    ...
    object qrySeverableArzTypeID: TIntegerField
      FieldName = 'ArzTypeID'
    end
    object qrySeverableArzRate: TFloatField
      DisplayLabel = #1606#1585#1582' '#1575#1585#1586
      FieldName = 'ArzRate'
    end
    object qrySeverable_ArzTypeID: TStringField
  ...
  object srcSeverable: TDataSource
    DataSet = qrySeverable
    OnStateChange = srcSeverableStateChange
    Left = 104
    Top = 208
  end
  ...
  object dsFormItems: TDataSource
    Left = 256
    Top = 17
  end
