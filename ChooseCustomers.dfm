inherited ChooseCustomersF: TChooseCustomersF
  Left = 258
  Top = 110
  ...
  inherited Panel1: TPanel
    ...
    inherited lblTopic1: TLabel
      ...
      AutoSize = False
      Caption = 
        #1576#1585#1575#1610' '#1575#1606#1578#1582#1575#1576' '#1605#1588#1578#1585#1610' '#1575#1586' '#1583#1603#1605#1607' Space '#1610#1575' Double Click '#1605#1608#1587' '#1575#1587#1578#1601#1575#1583#1607' '#1603#1606#1610#1583 +
        '.'
    end
  ...
  object qryCustomers: TADOQuery
    ...
    SQL.Strings = (
      ...
      'WHERE  GroupType = 0 or GroupType = 3'
  ...
  object cliCustomers: TClientDataSet
    ...
    object cliCustomersCustomerGrpID: TIntegerField
      DisplayLabel = #1603#1583' '#1711#1585#1608#1607
      FieldName = 'CustomerGrpID'
    end
    object cliCustomersCustomerGrpName: TStringField
