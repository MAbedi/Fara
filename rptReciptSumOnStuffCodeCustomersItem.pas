{ -----------------------------------------------------------------------------
  Unit Name: rptReciptSumOnStuffCodeCustomersItem
  Author:    Mahmood
  ----------------------------------------------------------------------------- }
unit rptReciptSumOnStuffCodeCustomersItem;
...
type
  TrptReciptSumOnStuffCodeCustomersItemF = class(Ttemplate2MDIF)
...
var
  rptReciptSumOnStuffCodeCustomersItemF: TrptReciptSumOnStuffCodeCustomersItemF;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.UpdateFilter;
begin
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.actFilterExecute
  (Sender: TObject);
var
  fi: TfilterF;
begin
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.FormShow(Sender: TObject);
begin
  inherited;
  MyParams.Clear;
  actFilter.Execute;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.FormResize(Sender: TObject);
begin
  inherited;
  SetColSize(DBGrid1, 1, True, Self.Name + formType);
end;

procedure TrptReciptSumOnStuffCodeCustomersItemF.FormDestroy(Sender: TObject);
begin
  inherited;
  SaveColWidth(DBGrid1, Self.Name + formType);
end;

procedure TrptReciptSumOnStuffCodeCustomersItemF.actSendExelExecute
  (Sender: TObject);
begin
  inherited;
  SendToExcel(DBGrid1);
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.qryStuffCodingAfterScroll
  (DataSet: TDataSet);
begin
  inherited;
  with qryRecipt_Items do
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.DBGrid1DrawColumnCell
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.actShowFormExecute
  (Sender: TObject);
begin
  inherited;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.DBGrid1DblClick
  (Sender: TObject);
begin
  inherited;
  actShowForm.Execute
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.ppSysVarPageNumberGetText
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.ppLblPrintDateGetText
  (Sender: TObject; var Text: String);
begin
  inherited;
  Text := GetPrintDate
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.ppLblCompanyNameGetText
  (Sender: TObject; var Text: String);
begin
  inherited;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.ppLblDateGetText
  (Sender: TObject; var Text: String);
begin
  inherited;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.SpeedButton1Click
  (Sender: TObject);
var
  b: Boolean;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.EdtStuffCodeKeyDown
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.actSearch_Execute
  (Sender: TObject);
begin
  inherited;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.actSortExecute
  (Sender: TObject);
begin
  inherited;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.actshowChartExecute
  (Sender: TObject);
begin
  inherited;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.actPrintExecute
  (Sender: TObject);
begin
  inherited;
  try
    ...
    InitReportFile(ppReport1, 'rptReciptSumOnStuffCodeCustomersItem', True);
  finally
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.actPrintVijehExecute
  (Sender: TObject);
begin
  inherited;
...
procedure TrptReciptSumOnStuffCodeCustomersItemF.ppLblCaptionGetText
  (Sender: TObject; var Text: String);
begin
  inherited;
  Text := Caption;
