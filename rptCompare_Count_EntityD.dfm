inherited rptCompare_Count_EntityDF: TrptCompare_Count_EntityDF
  Left = 403
  Top = 150
  ...
  object qryCountingItems: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT *  FROM Fn_rptCompare_Count_EntityD ( :YearIDFrom  , :Yea' +
        'rIDTo , :Date , :StoreID , :CountID  )'
      ''
      'ORDER BY StuffCode'
      ''
      '')
    ...
    object qryCountingItemsPrice: TBCDField
      Tag = 3
    ...
    object qryCountingItemsDifferPrice: TFloatField
      Tag = 3
      DisplayLabel = #1605#1576#1604#1594' '#1605#1608#1580#1608#1583#1610
      FieldName = 'DifferPrice'
      currency = True
    end
    object qryCountingItemsTotallSellPrice: TBCDField
      Tag = 3
    ...
    object qryCountingItemsCountEntity: TFMTBCDField
      Tag = 3
