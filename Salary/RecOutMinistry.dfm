inherited RecOutMinistryF: TRecOutMinistryF
  Left = 382
  Top = 122
  ...
  object Panel3: TPanel [2]
    ...
    object Label3: TLabel
      ...
      Alignment = taRightJustify
      Anchors = [akTop, akRight]
      Caption = #1578#1575#1585#1610#1582' '#1605#1589#1608#1576#1607
      FocusControl = edtResolutionDate
      ExplicitLeft = 648
    end
    ...
    object Label7: TLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = #1588#1605#1575#1585#1607' '#1605#1589#1608#1576#1607
    end
    ...
    object Label14: TLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = #1605#1587#1578#1606#1583#1575#1578' '#1578
      FocusControl = edtDocumentationT
    end
    object Label6: TLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = #1605#1587#1578#1606#1583#1575#1578' '#1605
    end
    object Label15: TLabel
      ...
      Alignment = taRightJustify
      Anchors = [akTop, akRight]
      Caption = #1605#1587#1578#1606#1583#1575#1578' '#1588
      FocusControl = edtDocumentationS
      ExplicitLeft = 648
    end
    ...
    object Label17: TLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = #1575#1585#1578#1576#1575#1591' '#1587#1575#1576#1602#1607
    end
    ...
    object Label12: TLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = #1603#1587#1585' '#1580#1576#1607#1607
      FocusControl = edtFractionFront
    end
    object cmbjobID: TDBComboBox
      Left = 223
      Top = 61
      Width = 160
      Height = 21
    ...
    object edtResolutionDate: TDBEdit
      Left = 468
      Top = 87
      Width = 160
      Height = 21
    ...
    object cmbBudget: TDBComboBox
      ...
      DataSource = srcRecOutMinistry
      Items.Strings = (
        #1583#1608#1604#1578#1610
        #1582#1589#1608#1589#1610)
      TabOrder = 5
    end
    object cmbServiceLocation: TDBComboBox
      Left = 468
      Top = 61
      Width = 160
      Height = 21
    ...
    object cmbWorkType: TDBComboBox
      Left = 223
      Top = 34
      Width = 160
      Height = 21
      ...
      DataSource = srcRecOutMinistry
      Items.Strings = (
        #1578#1605#1575#1605' '#1608#1602#1578
        #1662#1575#1585#1607' '#1608#1602#1578
        #1605#1588#1575#1608#1585#1607)
      ParentBiDiMode = False
      TabOrder = 4
    end
    object edtResolutionNo: TDBEdit
      Left = -12
      Top = 61
      Width = 160
      Height = 21
      Anchors = [akTop, akRight]
      DataField = 'ResolutionNo'
      DataSource = srcRecOutMinistry
      TabOrder = 8
      ExplicitLeft = 4
    end
    object edtDocumentationT: TDBEdit
      Left = 239
      Top = 87
      Width = 160
      Height = 21
      DataField = 'DocumentationT'
      DataSource = srcRecOutMinistry
      TabOrder = 10
    end
    object edtDocumentationM: TDBEdit
      Left = -12
      Top = 88
      Width = 160
      Height = 21
      Anchors = [akTop, akRight]
      DataField = 'DocumentationM'
      DataSource = srcRecOutMinistry
      TabOrder = 11
      ExplicitLeft = 4
    end
    object edtDocumentationS: TDBEdit
      Left = 468
      Top = 114
      Width = 160
      Height = 21
    ...
    object cmbContactHistory: TDBComboBox
      Tag = 4
      Left = 4
      Top = 115
      Width = 160
      Height = 21
      DataField = 'ContactHistory'
      DataSource = srcRecOutMinistry
      Items.Strings = (
        #1605#1601#1610#1583' '#1608' '#1582#1583#1605#1578
        #1582#1583#1605#1578
        #1605#1601#1610#1583)
      TabOrder = 14
    end
    ...
    object edtFractionFront: TDBEdit
      Left = 239
      Top = 141
      Width = 160
      Height = 21
      DataField = 'FractionFront'
      DataSource = srcRecOutMinistry
      TabOrder = 16
    end
  end
  ...
  object qryRecOutMinistry: TADOQuery
    Connection = DmF.adcsalary
    CursorType = ctStatic
    AfterInsert = qryRecOutMinistryAfterInsert
    BeforePost = qryRecOutMinistryBeforePost
    AfterPost = qryRecOutMinistryAfterPost
    BeforeDelete = qryRecOutMinistryBeforeDelete
    AfterDelete = qryRecOutMinistryAfterDelete
    Parameters = <
      item
        Name = 'PersonelNo'
        Attributes = [paSigned]
    ...
    SQL.Strings = (
        ...
        'SELECT   *, Pay.GetDifferenceDate(OfDate, ToDate, 0) AS day, dbo' +
    ...
    Left = 168
    Top = 312
    object qryRecOutMinistryID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object qryRecOutMinistryPersonelNo: TIntegerField
      DisplayLabel = #1588#1605#1575#1585#1607' '#1662#1585#1587#1606#1604#1610
      FieldName = 'PersonelNo'
      Required = True
    end
    object qryRecOutMinistry_PersonelName: TStringField
    ...
    object qryRecOutMinistry_Name: TStringField
      FieldKind = fkLookup
      FieldName = '_Name'
      LookupDataSet = qryPersonelInfo
      LookupKeyFields = 'PersonelNo'
    ...
    object qryRecOutMinistry_lastName: TStringField
      FieldKind = fkLookup
      FieldName = '_lastName'
      LookupDataSet = qryPersonelInfo
      LookupKeyFields = 'PersonelNo'
    ...
    object qryRecOutMinistryOfDate: TStringField
    ...
    object qryRecOutMinistryToDate: TStringField
    ...
    object qryRecOutMinistrySectionAcademic: TIntegerField
      FieldName = 'SectionAcademic'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryEmploymentType: TIntegerField
      FieldName = 'EmploymentType'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryWorkType: TIntegerField
      FieldName = 'WorkType'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryBudget: TIntegerField
      FieldName = 'Budget'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryServiceLocation: TIntegerField
      FieldName = 'ServiceLocation'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryjobID: TIntegerField
      FieldName = 'jobID'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryResolutionNo: TStringField
      FieldName = 'ResolutionNo'
      Size = 25
    end
    object qryRecOutMinistryResolutionDate: TStringField
      FieldName = 'ResolutionDate'
      EditMask = '9999/99/99'
      FixedChar = True
      Size = 10
    end
    object qryRecOutMinistryDocumentationT: TStringField
      FieldName = 'DocumentationT'
      Size = 25
    end
    object qryRecOutMinistryDocumentationM: TStringField
      FieldName = 'DocumentationM'
      Size = 25
    end
    object qryRecOutMinistryDocumentationS: TStringField
      FieldName = 'DocumentationS'
      Size = 25
    end
    object qryRecOutMinistryTypeHistory: TIntegerField
      FieldName = 'TypeHistory'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryContactHistory: TIntegerField
      FieldName = 'ContactHistory'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryEmploymentStatus: TIntegerField
      FieldName = 'EmploymentStatus'
      OnGetText = ALLGetText
      OnSetText = AllSetText
    end
    object qryRecOutMinistryFractionFront: TBCDField
      FieldName = 'FractionFront'
      Precision = 18
    end
    object qryRecOutMinistryday: TWideStringField
      DisplayLabel = #1605#1583#1578' '#1575#1587#1575#1585#1578'('#1585#1608#1586')'
      FieldName = 'day'
      ReadOnly = True
      Size = 1000
    end
    object qryRecOutMinistryLimit: TWideStringField
  ...
  object srcRecOutMinistry: TDataSource
    AutoEdit = False
    DataSet = qryRecOutMinistry
    OnStateChange = srcRecOutMinistryStateChange
    Left = 64
    Top = 304
  end
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\Projects\Fara2010\Salary\Exe\Report\RecOutMinistry.rtm'
