inherited SalaryList4CTopicCodeF: TSalaryList4CTopicCodeF
  Left = 345
  Top = 87
  ...
  object qrysalary: TADOQuery
    ...
    SQL.Strings = (
      'SELECT  *'
      'FROM         Pay.SalaryWageDecList() AS SalaryWageDecList_1'
      'WHERE       ('#1603#1583#1605#1585#1603#1586#1607#1586#1610#1606#1607' =  :CTopicCode )')
    Left = 72
    Top = 296
  end
  ...
  object srcCTopicCode: TDataSource
    DataSet = qryCTopicCode
    Left = 176
    Top = 152
  end
  object qryCTopicCode: TADOQuery
    ...
    CursorType = ctStatic
    LockType = ltReadOnly
    AfterScroll = qryCTopicCodeAfterScroll
    Parameters = <>
    SQL.Strings = (
      
        'SELECT     acc.CenterTopics.CTopicCode AS Mastercode, acc.Center' +
        'Topics.CTopicName_L1 AS name'
      'FROM         acc.CenterTopics INNER JOIN'
      
        '                      acc.CenterTopicRange ON acc.CenterTopics.C' +
        'TopicCode = acc.CenterTopicRange.CTopicCode'
      
        'GROUP BY acc.CenterTopics.CTopicCode, acc.CenterTopics.CTopicNam' +
        'e_L1')
    Left = 64
    Top = 160
    object qryCTopicCodeMastercode: TIntegerField
      FieldName = 'Mastercode'
    end
    object qryCTopicCodename: TStringField
      FieldName = 'name'
      Size = 120
    end
  end
