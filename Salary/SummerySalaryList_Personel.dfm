inherited SummerySalaryList_PersonelF: TSummerySalaryList_PersonelF
  Left = 351
  Top = 215
  ...
  object qryComprasion: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'AND    ( (OfficeCode BETWEEN :FromOfficeCode  AND :ToOfficeCode)' +
        ' OR(OfficeCode=0))'
      '    '
  ...
  object qryPersonel: TADOQuery
    ...
    SQL.Strings = (
        ...
        '+ PersonelInfo.lastName_L1 AS Name_L1, '
      
        '                      PersonelInfo.name_L2 + '#39'  '#39' + PersonelInfo' +
        '.lastName_L2 AS Name_L2,PersonelInfo.Mobile'
      ...
      ''
        ...
        '                      PersonelInfo.name_L2 + '#39'  '#39' + PersonelInfo' +
        '.lastName_L2, FormsInfo.InfoID, Interdicts.State,PersonelInfo.Mo' +
        'bile')
    Left = 56
    Top = 112
    ...
    object qryPersonelMobile: TStringField
      Tag = 3
