inherited SalaryList4OfficeF: TSalaryList4OfficeF
  Left = 375
  Top = 264
  Caption = '2-'#1604#1610#1587#1578' '#1581#1602#1608#1602' '#1576#1575' '#1608#1575#1581#1583' '#1587#1575#1586#1605#1575#1606#1610
  ClientWidth = 846
  OnResize = FormResize
  ExplicitWidth = 854
  PixelsPerInch = 96
  ...
  inherited Panel2: TPanel
    ...
    inherited lblCaption: TLabel
      ...
      Width = 214
      Height = 16
      Caption = #1604#1610#1587#1578' '#1581#1602#1608#1602' '#1576#1578#1601#1603#1610#1603' '#1608#1575#1581#1583' '#1587#1575#1586#1605#1575#1606#1610
      ExplicitLeft = 586
      ExplicitWidth = 214
    end
  ...
  inherited Panel3: TPanel
    ...
    object grd1: TCedarDbgrid
      ...
      SumList.Active = True
      TabOrder = 1
      OnSumListAfterRecalcAll = grd1SumListAfterRecalcAll
  ...
  object qrysalary: TADOQuery
    ...
    SQL.Strings = (
        ...
        '      Pay.Functions_Sum.FunctionDay, Pay.Functions_Sum.FunctionT' +
        'ime,PersonelInfo.fatherName_L1,'
      ...
      ''
        ...
        '      FROM         Pay.Functions_Sum INNER JOIN   Pay.PersonelIn' +
        'fo ON Pay.Functions_Sum.PersonelNo = Pay.PersonelInfo.PersonelNo'
      '                      RIGHT OUTER JOIN'
      
        '                      Pay.FixedCalculated ON Pay.PersonelInfo.Pe' +
        'rsonelNo = Pay.FixedCalculated.PersonelNO LEFT OUTER JOIN'
      ...
      'and  (Pay.FormsInfo.InfoID  BETWEEN :FromInfoID AND :ToInfoID) '
        ...
        '                      Pay.PersonelInfo.name_L1 + '#39' '#39' + Pay.Perso' +
        'nelInfo.lastName_L1,PersonelInfo.name_L1 ,PersonelInfo.lastName_' +
        'L1,PersonelInfo.fatherName_L1'
      
        ', Pay.Functions_Sum.FunctionDay, Pay.Functions_Sum.FunctionTime,' +
        ' Pay.Functions_Sum.Mounth')
    Left = 264
    Top = 216
  end
  ...
  object PopList4Print: TPopupMenu
    ...
    object SalaryList_office: TMenuItem
      Caption = #1670#1575#1662' '#1576#1578#1601#1603#1610#1603' '#1608#1575#1581#1583' '#1607#1575
      Hint = 'InfoID'
      OnClick = AllClickClick
    end
    object SalaryList: TMenuItem
      Caption = #1670#1575#1662' '#1576#1575' '#1603#1604#1610#1607' '#1608#1575#1581#1583#1607#1575
      Hint = 'InfoID'
      OnClick = AllClickClick
    end
    object SalaryList4OfficeF1Row: TMenuItem
      Caption = #1670#1575#1662' '#1610#1603' '#1587#1591#1585#1610
      Hint = 'InfoID'
      OnClick = AllClickClick
    end
    object SalaryList_officePersonelState: TMenuItem
      Caption = #1670#1575#1662' '#1576#1585#1575#1587#1575#1587' '#1608#1590#1593#1610#1578' '#1662#1585#1587#1606#1604
      Hint = 'PersonelState'
      OnClick = AllClickClick
    end
    object SalaryList_PersonelStateSum: TMenuItem
      Caption = #1670#1575#1662' '#1576#1585#1575#1587#1575#1587' '#1587#1585#1580#1605#1593' '#1608#1590#1593#1610#1578' '#1662#1585#1587#1606#1604
      Hint = 'PersonelState'
      OnClick = AllClickClick
    end
    object SalaryList_EmployTypeCode: TMenuItem
      Caption = #1670#1575#1662' '#1576#1585#1575#1587#1575#1587' '#1606#1608#1593' '#1581#1603#1605
      Hint = 'EmployTypeCode'
      OnClick = AllClickClick
    end
    object SalaryList_ProjectID: TMenuItem
      Caption = #1670#1575#1662' '#1576#1585#1575#1587#1575#1587' '#1662#1585#1608#1688#1607'/'#1578#1601#1589#1610#1604#1610'2'
      Hint = 'ProjectID'
      OnClick = AllClickClick
    end
  end
