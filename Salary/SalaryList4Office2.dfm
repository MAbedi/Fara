inherited SalaryList4Office2F: TSalaryList4Office2F
  Left = 345
  Top = 87
  ...
  inherited Panel2: TPanel
    inherited lblCaption: TLabel
      ...
      Width = 226
      Height = 16
      Caption = #1604#1610#1587#1578' '#1581#1602#1608#1602' '#1576#1578#1601#1603#1610#1603' '#1608#1575#1581#1583' '#1587#1575#1586#1605#1575#1606#1610' 2'
      ExplicitLeft = 514
      ExplicitWidth = 226
    end
  ...
  object qrysalary: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT      FixedCalculated.OfficeCode, FixedCalculated.Personel' +
        'NO, Pay.FormsInfo.InfoName_L1 AS OfficeName,Pay.FormsInfo.InfoID' +
        ' ,'
      
        '                      Pay.PersonelInfo.name_L1 + '#39' '#39' + Pay.Perso' +
        'nelInfo.lastName_L1 AS PersonName, PersonelInfo.name_L1 , Person' +
        'elInfo.lastName_L1 ,PersonelInfo.fatherName_L1 ,'
  ...
  object qryWage: TADOQuery
    ...
    SQL.Strings = (
      ...
      'AND (FixedCalculated.ArchiveID = :ArchiveID)'
        ...
        'sInfo_2.FormInfoID,MounthRetard,Mounth'
  ...
  object qryOffice: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     Pay.FormsInfo.InfoID as OfficeCode, Pay.FormsInfo.Inf' +
        'oName_L1 as OfficeName_L1'
      ...
      'WHERE     (Pay.FormsInfo.FormType = 12)'
        ...
        'AND (Pay.FormsInfo.InfoID BETWEEN :OfficeCodeFrom AND :OfficeCod' +
        'eTo)'
      'GROUP BY Pay.FormsInfo.InfoID, Pay.FormsInfo.InfoName_L1')
    Left = 560
    Top = 128
    object qryOfficeOfficeCode: TIntegerField
      FieldName = 'OfficeCode'
    end
    object qryOfficeOfficeName_L1: TStringField
