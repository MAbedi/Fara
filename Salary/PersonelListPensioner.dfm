inherited PersonelListPensionerF: TPersonelListPensionerF
  Left = 329
  Top = 168
  ...
  object qryListPensioner: TADOQuery
    ...
    SQL.Strings = (
      'SELECT     InfoName_L1, InfoName_L2, 0 AS ShowListKind,'
        ...
        '                      FixedCalculated ON PersonelInfo.PersonelNo' +
        ' = FixedCalculated.PersonelNO'
  ...
  object qryInsurance: TADOQuery
    ...
    SQL.Strings = (
      'SELECT DISTINCT '
        ...
        '                         FixedCalculated.SalaryID, FixedCalculat' +
        'ed.ShowListKind, PersonelInfo.insuranceID, '
      
        '                         CASE Pay.FixedCalculated.ShowListKind W' +
        'HEN 4 THEN ltrim(CAST(Pay.InsuranceCONSTinfo.Employershare AS va' +
        'rchar(10)) '
      
        '                         + '#39' '#1583#1585#1589#1583' '#39' + Pay.InsuranceCONSTinfo.ins' +
        'urancename) WHEN 2 THEN ltrim(CAST(Pay.InsuranceCONSTinfo.Employ' +
        'eeshare AS varchar(10)) '
      
        '                         + '#39' '#1583#1585#1589#1583' '#39' + Pay.InsuranceCONSTinfo.ins' +
        'urancename) ELSE '#39#1605#1588#1605#1608#1604' '#39' + Pay.InsuranceCONSTinfo.insurancename' +
        ' END AS InfoName_L1, '
      
        '                         InsuranceCONSTinfo.insurancename AS Inf' +
        'oName_L2'
      'FROM Pay.FixedCalculated LEFT OUTER JOIN'
      '                         Pay.InsuranceCONSTinfo INNER JOIN'
      
        '                         Pay.PersonelInfo ON InsuranceCONSTinfo.' +
        'insuranceNo = PersonelInfo.insuranceID ON FixedCalculated.Salary' +
        'ID = InsuranceCONSTinfo.FormInfoID AND '
      
        '                         FixedCalculated.PersonelNO = PersonelIn' +
        'fo.PersonelNo'
      
        'WHERE        (NOT (PersonelInfo.insuranceID IS NULL)) AND (Fixed' +
        'Calculated.ShowListKind IN (2, 3, 4))')
    Left = 105
    Top = 183
  end
