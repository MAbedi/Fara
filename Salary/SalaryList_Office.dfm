inherited SalaryList_OfficeF: TSalaryList_OfficeF
  Left = 205
  Top = 127
  ...
  object qryComprasion: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        ' :YearIDTo   ,:YearsFrom ,:YearsTo  ) AS RptComprasion INNER JOI' +
        'N'
      ...
      ''
      '(RptComprasion.OfficeCode = :OfficeCode)'
  ...
  object qryOfficeCode: TADOQuery
    ...
    CursorType = ctStatic
    LockType = ltReadOnly
    AfterScroll = qryOfficeCodeAfterScroll
    Parameters = <
      item
        Name = 'FromOfficeCode'
    ...
    SQL.Strings = (
      ...
      'FROM         Pay.FormsInfo'
        ...
        'WHERE   (FormType = 12) AND (InfoID BETWEEN :FromOfficeCode  AND' +
        ' :ToOfficeCode)'
      'ORDER BY InfoID')
    Left = 352
    Top = 8
    object qryOfficeCodeOfficeCode: TIntegerField
      FieldName = 'OfficeCode'
    end
    object qryOfficeCodeInfoName_L1: TStringField
      FieldName = 'InfoName_L1'
      Size = 255
    end
  end
  object srcOfficeCode: TDataSource
    DataSet = qryOfficeCode
    Left = 432
    Top = 8
  end
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\Projects\Fara\Salary\Exe\Report\SummerySalaryList_office.rtm'
    Units = utMillimeters
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel3: TppLabel
        ...
        Border.mmPadding = 0
        Caption = #1582#1604#1575#1589#1607' '#1608#1590#1593#1610#1578' '#1581#1602#1608#1602' '#1608#1575#1581#1583#1607#1575#1610' '#1587#1575#1586#1605#1575#1606#1610' '#1587#1575#1604
        Font.Charset = ARABIC_CHARSET
        Font.Color = clBlack
        Font.Name = 'Yagut'
        Font.Size = 12
