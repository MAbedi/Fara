inherited rptReciptSumOnCustomersItemF: TrptReciptSumOnCustomersItemF
  Left = 370
  Top = 197
  ...
  object qryRecipt_Items: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Price) AS Price'
      ', ReciptItems.PersonID1, Customers.CustName'
      ''
      'FROM         CustomersGroup LEFT OUTER JOIN'
      '                      Units INNER JOIN'
      ...
      '                      Stores INNER JOIN'
        ...
        '.CustID ON ReciptItems.YearID = Recipts.YearID AND ReciptItems.S' +
        'erverID = Recipts.ServerID AND '
      
        '                      ReciptItems.ReciptID = Recipts.ReciptID ON' +
      ...
      ''
        ...
        'UnitName, ReciptItems.PersonID1, Customers.CustName')
    Left = 216
    Top = 233
