inherited RptReciptWithCustF: TRptReciptWithCustF
  Left = 296
  Top = 105
  ...
  object qryWithCust: TADOQuery
    ...
    SQL.Strings = (
        ...
        'me, Recipts.PersonID1 AS PersonID1'
      ...
      ',Customers.NationalID , Customers.EconomicNumber'
      
        ',Customers.Mobile,Customers.Address, AVG(ReciptItems.UnitSellPri' +
        'ce ) AS UnitSellPrice'
      ''
      ...
      '                      ReciptItems INNER JOIN'
        ...
        'Types.ReciptType ON Customers.CustID = Recipts.PersonID1'
      ''
      ' INNER JOIN'
      ...
      '     (Recipts.StoreID BETWEEN :StoreIDFrom AND :StoreIDTo)'
        ...
        '     AND (Recipts.ReciptNumber BETWEEN  :ReciptNumberFrom   AND ' +
        ' :ReciptNumberTo) AND'
      ...
      'AND (Recipts.ReciptType IN (:type))'
      'AND (Recipts.PersonID1 BETWEEN :custIdfrom AND :custIdto)'
      'AND (Recipts.PersonID2 BETWEEN :custId2from AND :custId2to)'
      
        'AND (Customers.CustomerGrpID BETWEEN :customergrpIdfrom AND :cus' +
        'tomergrpIdto)'
      ...
      'AND (Recipts.YearID BETWEEN :YearIDFrom AND :YearIDTo)'
        ...
        'GROUP BY Recipts.ReciptType, ReciptTypes.ReciptCaption, Recipts.' +
        'PersonID1, Customers.CustName, Customers.CustomerGrpID,'
      
        '                      CustomersGroup.CustomerGrpName  ,Customers' +
        '.CustFirstName,Customers.NationalID , Customers.EconomicNumber'
    ...
    object qryWithCustNationalID: TStringField
      Tag = 3
      DisplayLabel = #1705#1583' '#1605#1604#1740
      FieldName = 'NationalID'
      Size = 12
    end
    object qryWithCustEconomicNumber: TStringField
      Tag = 3
      DisplayLabel = #1588#1605#1575#1585#1607' '#1575#1602#1578#1589#1575#1583#1740
      FieldName = 'EconomicNumber'
    end
    object qryWithCustMobile: TStringField
      Tag = 3
      DisplayLabel = #1578#1604#1601#1606' '#1607#1605#1585#1575#1607
      FieldName = 'Mobile'
    end
    object qryWithCustAddress: TStringField
      Tag = 3
      DisplayLabel = #1570#1583#1585#1587
      FieldName = 'Address'
      Size = 300
    end
    object qryWithCustUnitSellPrice: TFMTBCDField
      Tag = 3
      DisplayLabel = #1601#1740' '#1605#1740#1575#1606#1711#1740#1606
      FieldName = 'UnitSellPrice'
      ReadOnly = True
      currency = True
      Precision = 38
