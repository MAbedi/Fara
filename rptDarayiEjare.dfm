inherited rptDarayiEjareF: TrptDarayiEjareF
  Left = 303
  Caption = #1711#1586#1575#1585#1588' '#1579#1576#1578' '#1575#1591#1604#1575#1593#1575#1578' '#1602#1585#1575#1585#1583#1575#1583' '#1575#1580#1575#1585#1607' '#1580#1607#1578' '#1583#1575#1585#1575#1574#1610
  ClientWidth = 983
  ExplicitWidth = 999
  PixelsPerInch = 96
  TextHeight = 13
  inherited PnlUnderButton: TPanel
    ...
    object btnEmployerId: TBitBtn
      ...
      Margins.Bottom = 6
      Align = alRight
      Caption = #1575#1591#1604#1575#1593#1575#1578' '#1591#1585#1601
      TabOrder = 6
    ...
    object btnWorkShopId: TBitBtn
      ...
      Margins.Bottom = 6
      Align = alRight
      Caption = #1575#1591#1604#1575#1593#1575#1578' '#1605#1604#1705
      TabOrder = 8
      OnClick = btnWorkShopIdClick
    end
    object btnEjareF: TBitBtn
      AlignWithMargins = True
      Left = 661
      Top = 7
      Width = 75
      ...
      Margins.Bottom = 6
      Align = alRight
      Caption = #1575#1591#1604#1575#1593#1575#1578' '#1602#1585#1575#1585#1583#1575#1583
      TabOrder = 9
      OnClick = btnEjareFClick
    end
  end
    ...
    object DBGrid1: TCedarDbgrid
      ...
      Columns = <
        ...
        item
          ...
          DynProps = <>
          EditButtons = <>
          FieldName = 'T_LastNameSherkatName'
          Footers = <>
          Title.TitleButton = True
          Width = 64
        end
  ...
  object srcEjare: TDataSource
    DataSet = qryEjare
    Left = 216
    Top = 261
  end
  object qryEjare: TADOQuery
    ...
    SQL.Strings = (
      'SELECT   *'
        ...
        'FROM  dbo.Fn_DarayiEjare(:CustIdFrom , :CustIdTo, :SeasonFrom , ' +
        ':SeasonTo'
      
        ', :DateFrom, :DateTo, :CustomerGrpIDFrom, :CustomerGrpIDTo, :Yea' +
        'rIDFrom, :YearIDTo'
      ', :ContractsStatus) AS Fn_DarayiEjare_1')
    Left = 336
    Top = 165
    object qryEjareCaseNo: TIntegerField
      FieldName = 'CaseNo'
    end
    object qryEjareRadif: TIntegerField
      FieldName = 'Radif'
    end
    object qryEjareTarafeGharardadType: TWordField
      FieldName = 'TarafeGharardadType'
    end
    object qryEjareTedadShoraka: TStringField
      FieldName = 'TedadShoraka'
      ReadOnly = True
      Size = 1
    end
    object qryEjareGharardadNumber: TStringField
      FieldName = 'GharardadNumber'
      Size = 30
    end
    object qryEjareGharardadDate: TStringField
      FieldName = 'GharardadDate'
      FixedChar = True
      Size = 10
    end
    object qryEjareGharardadTypeCode: TWordField
      FieldName = 'GharardadTypeCode'
    end
    object qryEjareEjariType: TWordField
      FieldName = 'EjariType'
    end
    object qryEjareTozih: TStringField
      FieldName = 'Tozih'
      Size = 255
    end
    object qryEjareVasile: TWordField
      FieldName = 'Vasile'
    end
    object qryEjareKarbariType: TWordField
      FieldName = 'KarbariType'
    end
    object qryEjareMelk_StateCode: TIntegerField
      FieldName = 'Melk_StateCode'
    end
    object qryEjareMelk_CityCode: TIntegerField
      FieldName = 'Melk_CityCode'
    end
    object qryEjareMelk_Address: TStringField
      FieldName = 'Melk_Address'
      Size = 200
    end
    object qryEjareMelk_PostCode: TStringField
      FieldName = 'Melk_PostCode'
      Size = 12
    end
    object qryEjareMelk_TellPishCode: TStringField
      FieldName = 'Melk_TellPishCode'
      Size = 10
    end
    object qryEjareMelk_Tell: TStringField
      FieldName = 'Melk_Tell'
      Size = 30
    end
    object qryEjarePelakSabtiAsli: TStringField
      FieldName = 'PelakSabtiAsli'
      FixedChar = True
      Size = 25
    end
    object qryEjarePelakSabtiFari: TStringField
      FieldName = 'PelakSabtiFari'
      FixedChar = True
      Size = 25
    end
    object qryEjareBakhshSabti: TWideStringField
      FieldName = 'BakhshSabti'
      Size = 60
    end
    object qryEjareShenaseMelk: TStringField
      FieldName = 'ShenaseMelk'
      Size = 30
    end
    object qryEjareMozuType: TWordField
      FieldName = 'MozuType'
    end
    object qryEjareNaKhales: TBCDField
      FieldName = 'NaKhales'
      Precision = 19
    end
    object qryEjareT_TypeCode: TWordField
      FieldName = 'T_TypeCode'
    end
    object qryEjareT_Tabeiat: TWordField
      FieldName = 'T_Tabeiat'
    end
    object qryEjareT_Name: TStringField
      FieldName = 'T_Name'
      Size = 30
    end
    object qryEjareT_LastNameSherkatName: TStringField
      FieldName = 'T_LastNameSherkatName'
      Size = 150
    end
    object qryEjareT_EconomicNO: TStringField
      FieldName = 'T_EconomicNO'
      Size = 12
    end
    object qryEjareT_NationalCode: TStringField
      FieldName = 'T_NationalCode'
      Size = 12
    end
    object qryEjareT_TellPishCode: TStringField
      FieldName = 'T_TellPishCode'
      Size = 10
    end
    object qryEjareT_Tell: TStringField
      FieldName = 'T_Tell'
      Size = 30
    end
    object qryEjareT_StateCode: TIntegerField
      FieldName = 'T_StateCode'
    end
    object qryEjareT_CityCode: TIntegerField
      FieldName = 'T_CityCode'
    end
    object qryEjareT_Address: TStringField
      FieldName = 'T_Address'
      Size = 200
    end
    object qryEjareT_PostCode: TStringField
      FieldName = 'T_PostCode'
      Size = 12
    end
    object qryEjareEmployerId: TIntegerField
      FieldName = 'EmployerId'
    end
    object qryEjareWorkShopId: TIntegerField
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\Projects\Fara2010\BSell\Exe\Report\rptDarayiEjare.rtm'
    Units = utMillimeters
  ...
  object qryEjare_Detail: TADOQuery
    Connection = frmTax.adcTTMS
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM Ejare_Detail')
    Left = 136
    Top = 168
  end
end
