...
SELECT 1003,1,N'روز','SUBSTRING(FunctionSpecialControl.ControlDate,9,2)',NULL,'','',''
	UNION ALL
SELECT 1004,1,N'واحد سازماني','FunctionSpecialControl.OfficeCode','(SELECT InfoID, InfoName_L1 as OfficeName FROM pay.FormsInfo WHERE FormType = 12)','OfficeName','Office','InfoID'
	UNION ALL
SELECT 1005,1,N'كد پرسنل','Pay.FunctionSpecialControl.PersonelNo','Pay.PersonelInfo','name_L1+'' ''+lastName_L1','C1','PersonelNo'	
	UNION ALL
SELECT 1006,1,N'كد پروژه','FunctionSpecialControl.ProjectID','(SELECT InfoID, InfoName_L1 as ProjectName FROM pay.FormsInfo WHERE FormType  in(39,40,41) )','ProjectName','Project','InfoID'
	UNION ALL
SELECT 1007,1,N'كد خودرو','FunctionSpecialControl.CarCode','(SELECT InfoID, InfoName_L1 as CarName FROM pay.FormsInfo WHERE FormType = 96)','CarName','Car','InfoID'
	UNION ALL
SELECT 1008,1,N'كد محصول','FunctionSpecialControl.ProcCode','(SELECT InfoID, InfoName_L1 as ProcName FROM pay.FormsInfo WHERE FormType = 67)','ProcName','Procs','InfoID'
	UNION ALL
SELECT 1009,1,N'كد فعاليت','FunctionSpecialControl.ActivityCode','(SELECT InfoID, InfoName_L1 as ActivityName FROM pay.FormsInfo WHERE FormType = 66)','ActivityName','Activity','InfoID'
	UNION ALL
SELECT 1010,1,N'نوع كاركرد','FunctionSpecialControl.FunctionKind','(SELECT InfoID, InfoName_L1 as FunctionKindName FROM pay.FormsInfo WHERE FormType = 70)','FunctionKindName','FunctionKinds','InfoID'
...
SELECT 1105,2,N'كد پرسنل','Pay.FunctionDayItems.PersonelNo','Pay.PersonelInfo','name_L1+'' ''+lastName_L1','C1','PersonelNo'	
	UNION ALL
SELECT 1106,2,N'كد حضور','FunctionDayItems.PeresentID','(SELECT InfoID, InfoName_L1 as PeresentName FROM pay.FormsInfo WHERE FormType = 64)','PeresentName','Peresents','InfoID'
	UNION ALL
SELECT 1107,2,N'كد شيفت','FunctionDayItems.ShiftNo','(SELECT InfoID, InfoName_L1 as ShiftName FROM pay.FormsInfo WHERE FormType = 65)','ShiftName','Shifts','InfoID'
	UNION ALL
SELECT 1108,2,N'نوع كار','FunctionDayItems.WorkID','(SELECT InfoID, InfoName_L1 as WorkName FROM pay.FormsInfo WHERE FormType = 66)','WorkName','WorkIDs','InfoID'
	UNION ALL
SELECT 1109,2,N'كد زمين','FunctionDayItems.EarthCode','(SELECT InfoID, InfoName_L1 as EarthName pay.FROM FormsInfo WHERE FormType = 69)','EarthName','Earths','InfoID'
	UNION ALL
SELECT 1110,2,N'كد محصول','FunctionDayItems.ProcCode','(SELECT InfoID, InfoName_L1 as ProcName pay.FROM FormsInfo WHERE FormType = 67)','ProcName','Procs','InfoID'

UNION ALL

SELECT 2401,3,N'كد پرسنل','Rpt_Comprasion2.PersonelNo','Pay.PersonelInfo','name_L1+'' ''+lastName_L1','C1','PersonelNo'	
	UNION ALL
SELECT 2402,3,N'واحد سازماني','Rpt_Comprasion2.OfficeCode','(SELECT InfoID, InfoName_L1 as OfficeName FROM pay.FormsInfo WHERE FormType = 12)','OfficeName','Office','InfoID'
	UNION ALL
SELECT 2403,3,N'كد پروژه','Rpt_Comprasion2.ProjectCode','(SELECT InfoID, InfoName_L1 as ProjectName FROM pay.FormsInfo WHERE FormType  in(39,40,41) )','ProjectName','Project','InfoID'
	UNION ALL
SELECT 2404,3,N'كد شغل','Rpt_Comprasion2.JobCode','(SELECT InfoID, InfoName_L1 as JobName FROM pay.FormsInfo WHERE FormType = 13)','JobName','Job','InfoID'
	UNION ALL
SELECT 2405,3,N'نوع مزايا','Rpt_Comprasion2.SalaryID','(SELECT FormInfoID, InfoName_L1  FROM pay.FormsInfo )','InfoName_L1','FormsInfo','FormInfoID'
	UNION ALL
...
SELECT 2407,3,N'سال‏','Rpt_Comprasion2.YearID','Util.MaliYear','StartYear+''تا''+EndYear','Y','YearID'
 ...
 SELECT 2412, 3, N'م‏ه3', N'Rpt_Comprasion2.AccCTopicCode3', N'%W%.Acc.CTopicCode3', N'CTopicName3_L1', N'FCT3', N'CTopicCode3'
	UNION ALL
SELECT 2413,3,N'كد محصول','Rpt_Comprasion2.ProcCode','(SELECT InfoID, InfoName_L1 as ProcName FROM pay.FormsInfo WHERE FormType = 67)','ProcName','Procs','InfoID'
...
SELECT 2601,4,N'كد پرسنل','Rpt_ProjectCostPrice.PersonelNo','Pay.PersonelInfo','name_L1+'' ''+C1.lastName_L1','C1','PersonelNo'	
	UNION ALL
SELECT 2602,4,N'واحد سازماني','Rpt_ProjectCostPrice.OfficeCode','(SELECT InfoID, InfoName_L1 as OfficeName FROM pay.FormsInfo WHERE FormType = 12)','OfficeName','Office','InfoID'
	UNION ALL
SELECT 2603,4,N'كد پروژه','Rpt_ProjectCostPrice.ProjectID','(SELECT InfoID, InfoName_L1 as ProjectName FROM pay.FormsInfo WHERE FormType in(39,40,41) )','ProjectName','Project','InfoID'
	UNION ALL
SELECT 2604,4,N'كد شغل','Rpt_ProjectCostPrice.JobCode','(SELECT InfoID, InfoName_L1 as JobName FROM pay.FormsInfo WHERE FormType = 13)','JobName','Job','InfoID'
	UNION ALL
