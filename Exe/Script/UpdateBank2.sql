----   UpdateBank 2   1400/03/24
SET NOCOUNT ON


IF OBJECT_ID ('TR_TozinEnterDate', 'TR') IS NOT NULL
ALTER TABLE Tozin DISABLE TRIGGER TR_TozinEnterDate

IF OBJECT_ID ('TR_UpdateTozinExitDate', 'TR') IS NOT NULL
ALTER TABLE Tozin DISABLE TRIGGER TR_UpdateTozinExitDate

declare @LinkServerName varchar(500)
select @LinkServerName=c.LinkServerName from Config c
update Config set LinkServerName=''

--IF OBJECT_ID ('TR_NotAllowUpdateLinkOnDeficits', 'TR') IS NOT NULL
--ALTER TABLE Deficits DISABLE TRIGGER TR_NotAllowUpdateLinkOnDeficits



--IF OBJECT_ID ('TR_TozinEnterDate', 'TR') IS NOT NULL
--ALTER TABLE Tozin ENABLE TRIGGER TR_TozinEnterDate
