inherited rptReciptListOnStuffCodeCustomersItemF: TrptReciptListOnStuffCodeCustomersItemF
  Left = 453
  Top = 239
  ...
  object qryRecipt_Items: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     Recipts.ReciptNumber, Recipts.ReciptDate, ReciptItems' +
        '.PersonID1, Customers.CustName, Recipts.AidNumber, Recipts.AidDa' +
        'te,'
      ...
      ', ReciptItems.ServerID, ReciptItems.YearID, ReciptItems.ItemNote'
      ''
      'FROM         Customers INNER JOIN'
      
        '                      ReciptItems ON Customers.CustID = ReciptIt' +
        'ems.PersonID1 INNER JOIN'
