...
uses
  ...
  Vcl.ExtCtrls, Vcl.Buttons, Data.Win.ADODB, Vcl.Menus, ppDB, ppDBPipe,
  ppParameter, ppDesignLayer, ppStrtch, ppRegion, ppCtrls, ppPrnabl, ppClass,
  ppBands, ppCache, ppComm, ppRelatv, ppReport, Data.DB, Vcl.DBCtrls,
  Vcl.Mask, Vcl.Imaging.pngimage, ppMemo, pptypes, SMSUnit, ppProd,
  DBGridEhGrouping, ToolCtrlsEh, DBGridEhToolCtrls, DynVarsEh, EhLibVCL,
  GridsEh, DBAxisGridsEh, DBGridEh, CedarDbGrid;

type
  TGetOtherMoney2F = class(Ttemplate2MDIF)
    okPanel: TPanel;
    BitBtn7: TBitBtn;
    BitBtn8: TBitBtn;
    ...
    ppDBPipeline1ppField57: TppField;
    ppDBPipeline1ppField58: TppField;
    ppDBPipeline1ppField59: TppField;
    ppDBPipeline1ppField60: TppField;
    ppDBPipeline1ppField61: TppField;
    ppDBPipeline1ppField62: TppField;
    ppDBPipeline1ppField63: TppField;
    ppDBPipeline1ppField64: TppField;
    ppDBPipeline1ppField65: TppField;
    ...
    Image1: TImage;
    LblRecNo: TLabel;
    qryAllFormsFormNumber: TIntegerField;
    qryAllFormsFormDate: TStringField;
    BitBtn15: TBitBtn;
...
var
  GetOtherMoney2F: TGetOtherMoney2F;
...
procedure TGetOtherMoney2F.CmbALLGetText(Sender: TField; var Text: String;
  DisplayText: Boolean);
begin
  inherited;
...
procedure TGetOtherMoney2F.CmbALLSetText(Sender: TField; const Text: String);
begin
  inherited;
  Sender.AsInteger :=
...
procedure TGetOtherMoney2F.initCombos;
var
...
procedure TGetOtherMoney2F.initFormQry;
var
  s, sOrderBy: string;
...
begin
  ...
  begin
    ...
    qryCustCreate(qryCust1, '1', GetOtherMoney2F);
  end; // if
  ...
  begin
    ...
    qryCustCreate(qryCust2, '2', GetOtherMoney2F);
  end; // if
  ...
  qryCustCreate(qryCust3, '3', GetOtherMoney2F);
  ...
  qryCustCreate(qryCust4, '4', GetOtherMoney2F);
  ...
  begin
    ...
    SQL.Add(',CustomerID3,CustomerID4,ParentFormID, ID, FormNumber, FormDate FROM Forms');
    SQL.Add('WHERE (FormType = :Type)');
...
procedure TGetOtherMoney2F.initFormPanel;
var
  b: Boolean;
begin
  With qryInit do
  begin
    ...
    lblCaption.Caption := FieldByName('FormCaption').AsString;
    myMdiChildrenTabs.Tabs[myMdiChildrenTabs.TabIndex] :=
      RightStr(Caption, 25) + '...';

    lblCaption.Hint := formType.ToString;
...
procedure TGetOtherMoney2F.qryFormsAfterInsert(DataSet: TDataSet);
begin
  inherited;
  ...
  GetOtherMoney2F.qryForms.FieldByName('ReciptID').AsInteger := opt.ReciptID;

  GetOtherMoney2F.qryForms.FieldByName('CustomerID2').AsInteger :=
    opt.CustomerID1;
  if opt.PayablePriceActive then
    GetOtherMoney2F.qryForms.FieldByName('Amount').AsCurrency :=
      opt.PayablePrice;
  if PnlAidInfo.Visible then
  begin
    GetOtherMoney2F.qryForms.FieldByName('AidInfoNo').AsString := opt.AidInfoNo;
    GetOtherMoney2F.qryForms.FieldByName('AidInfoDate').AsString :=
      opt.AidInfoDate;
  end;

  if DataSet.State in [dsInsert] then
    GetOtherMoney2F.actStateChange.Caption := 'ثبت پيش نويس';
  FormStateAutoStateChange(qryInit, GetOtherMoney2F.qryForms);
...
procedure TGetOtherMoney2F.srcFormsStateChange(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.SBtnCustomerID1Click(Sender: TObject);
var
  txt: String;
  b: Boolean;
...
procedure TGetOtherMoney2F.SBtnCustomerID2Click(Sender: TObject);
var
  txt: String;
  b: Boolean;
...
procedure TGetOtherMoney2F.EdtCustomerID1DblClick(Sender: TObject);
var
  T: TThread;
begin
  inherited;
...
procedure TGetOtherMoney2F.EdtCustomerID1KeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.EdtCustomerID2KeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.EdtAmountChange(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.EdtAmountEnter(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.EdtAmountExit(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.EdtAmountKeyUp(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
...
procedure TGetOtherMoney2F.SpeedButton4Click(Sender: TObject);
begin
  inherited;
  AccSpeedButtonTopicCode(qryForms, 'TopicCode')
end;

procedure TGetOtherMoney2F.SpeedButton3Click(Sender: TObject);
begin
  inherited;
  AccSpeedButtonDetailCode(qryForms, 'DetailCode', 'TopicCode')
end;

procedure TGetOtherMoney2F.SpeedButton5Click(Sender: TObject);
begin
  inherited;
  AccSpeedButtonCTopicCode(qryForms, 'CTopicCode', 'TopicCode')
end;

function TGetOtherMoney2F.validData: Boolean;
var
  s: String;
begin
  Result := False;
...
procedure TGetOtherMoney2F.qryFormsBeforePost(DataSet: TDataSet);
var
  DefaultDate: String;
begin
  inherited;
...
function TGetOtherMoney2F.ReMain4post: Boolean;
var
  c: Currency;
begin
  Result := True;
...
procedure TGetOtherMoney2F.SBtnFormNumberClick(Sender: TObject);
var
...
procedure TGetOtherMoney2F.EdtFNumKeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.actSearchExecute(Sender: TObject);
begin
  inherited;
  SBtnFormNumber.Click;
end;

procedure TGetOtherMoney2F.actPrintExecute(Sender: TObject);
var
  footer_: String;
begin
  inherited;
...
procedure TGetOtherMoney2F.actPrint1Execute(Sender: TObject);
var
  footer_: String;
begin
  inherited;
...
procedure TGetOtherMoney2F.actPrint2Execute(Sender: TObject);
var
  footer_: String;
begin
  inherited;
...
procedure TGetOtherMoney2F.ppDBTxtAmountLineGetText(Sender: TObject;
var Text: String);
begin
  inherited;
  Text := '/' + Text
...
procedure TGetOtherMoney2F.ppLblAmountGetText(Sender: TObject;
var Text: String);
begin
  inherited;
...
procedure TGetOtherMoney2F.ppLblCompanyNameGetText(Sender: TObject;
var Text: String);
begin
  inherited;
...
procedure TGetOtherMoney2F.ppLblCompanyDescGetText(Sender: TObject;
var Text: String);
begin
  inherited;
...
procedure TGetOtherMoney2F.qryFormsAmountChange(Sender: TField);
begin
  inherited;
...
procedure TGetOtherMoney2F.qryFormsArzAmountChange(Sender: TField);
var
  r: Currency;
begin
  inherited;
...
procedure TGetOtherMoney2F.qryFormsArzTypeIDChange(Sender: TField);
begin
  inherited;
  With DMf.qryTmpTmp do
  begin
...
procedure TGetOtherMoney2F.qryFormsArzTypeIDExchangeChange(Sender: TField);
begin
  inherited;
  With DMf.qryTmpTmp do
  begin
...
function TGetOtherMoney2F.ValidAidInfoNo(FormID: Integer): Boolean;
begin
  // Result := False;
...
procedure TGetOtherMoney2F.qryFormsBeforeDelete(DataSet: TDataSet);
begin
  inherited;
  if not CheckDay4Edit(qryInit, qryForms, 1) then
    Abort;
...
procedure TGetOtherMoney2F.qryAllFormsAfterScroll(DataSet: TDataSet);
begin
  inherited;
  try
    qryForms.DisableControls;
...
procedure TGetOtherMoney2F.qryFormsAfterDelete(DataSet: TDataSet);
begin
  inherited;
...
procedure TGetOtherMoney2F.qryFormsAfterPost(DataSet: TDataSet);
var
...
procedure TGetOtherMoney2F.initFormCreate(LimitShow: Boolean; CustID: Integer);
begin
...
procedure TGetOtherMoney2F.enter(gParam: Integer; LimitShow: Boolean = True;
CustID: Integer = 0; qryMaster: TADOQuery = nil;
qryCashCheckFormID: TADOQuery = nil);
var
  FormID, ServerID, YearID: Integer;
begin
  // GetOtherMoney2F := TGetOtherMoney2F.Create(Application);
  CreateMDIForm3(LimitShow, TGetOtherMoney2F, GetOtherMoney2F, mdiMainf, gParam,
    wsNormal);
  with GetOtherMoney2F do
  begin
    formType := gParam;
    FilterShow := LimitShow;
    CustomerID := CustID;
    initFormCreate(LimitShow, CustID);
    // initFormQry;
  end;
  if qryCashCheckFormID <> nil then
  begin
    GetOtherMoney2F.CashCheckFormID := qryCashCheckFormID.FieldByName('FormID')
      .AsInteger;
  ...
  with GetOtherMoney2F do
    try
      ...
      begin
        ...
        BrowseAllForms4QryCoffer(GetOtherMoney2F.qryAllForms, FormID,
          ServerID, YearID);
        if not GetOtherMoney2F.qryAllForms.locate('FormID;ServerID;YearID',
          VarArrayOf([FormID, ServerID, YearID]), []) then
          GetOtherMoney2F.qryAllForms.Insert;
      ...
      begin
        ...
        begin
          GetOtherMoney2F.qryForms.Insert;
        end
        else if not GetOtherMoney2F.qryAllForms.locate('FormID;ServerID;YearID',
...
procedure TGetOtherMoney2F.DBEdit1KeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.DBEdit7KeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.DBEdit6KeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.ReMainPersonPaymentCash4Thread(Sender: TField;
LblReMainPerson: TLabel);
begin
...
procedure TGetOtherMoney2F.qryFormsCustomerID1Change(Sender: TField);
var
  // c: Currency;
  T: TThread;
begin
...
procedure TGetOtherMoney2F.qryFormsCustomerID2Change(Sender: TField);
var
  // c: Currency;
  T: TThread;
begin
...
procedure TGetOtherMoney2F.qryFormsCustomerID3Change(Sender: TField);
begin
  inherited;
  IF qryInit.FieldByName('Customer3Active').AsInteger = 1 THEN
...
procedure TGetOtherMoney2F.qryFormsCustomerID4Change(Sender: TField);
begin
  inherited;
  IF qryInit.FieldByName('Customer4Active').AsInteger = 1 THEN
...
procedure TGetOtherMoney2F.qryFormsDefaultDurationChange(Sender: TField);
begin
  inherited;
...
procedure TGetOtherMoney2F.btnRelatedReciptsClick(Sender: TObject);
begin
  inherited;
  SBtnRelatedReciptTypes(qryRelatedRecipts.SQL.Text, qryForms)
end;

procedure TGetOtherMoney2F.SpeedButton2Click(Sender: TObject);
begin
  inherited;
  AccSpeedButtonBudgetCode(qryForms, 'BudgetCode')
end;

procedure TGetOtherMoney2F.SpeedButton1Click(Sender: TObject);
begin
  inherited;
  AccSpeedButtonProjectsCode(qryForms, 'ProjectID', 'BudgetCode')
end;

procedure TGetOtherMoney2F.edtAidInfoNoKeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
...
procedure TGetOtherMoney2F.edtAidInfoDateKeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = VK_SPACE then
...
procedure TGetOtherMoney2F.SpeedButton6Click(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.SpeedButton7Click(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.btnCustomerID4Click(Sender: TObject);
var
  txt: String;
  b: Boolean;
...
procedure TGetOtherMoney2F.btnPrintClick(Sender: TObject);
begin
  inherited;
  popExcel.Popup(Mouse.CursorPos.X, Mouse.CursorPos.Y);
end;

procedure TGetOtherMoney2F.actExcelComparisonFExecute(Sender: TObject);
begin
  inherited;
  try
...
procedure TGetOtherMoney2F.actExitExecute(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TGetOtherMoney2F.EdtCustomerID2DblClick(Sender: TObject);
var
  T: TThread;
begin
  inherited;
...
procedure TGetOtherMoney2F.EdtCustomerID2Exit(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.ppLabel1GetText(Sender: TObject; var Text: string);
begin
  inherited;
  Text := miladi2Shamsi(now);
end;

procedure TGetOtherMoney2F.ppLbFormCaptionGetText(Sender: TObject;
var Text: String);
begin
  inherited;
  Text := Caption;
...
procedure TGetOtherMoney2F.ppImage1DrawCommandCreate(Sender,
...
procedure TGetOtherMoney2F.ppImage2DrawCommandCreate(Sender,
  aDrawCommand: TObject);
var
  s: String;
begin
...
procedure TGetOtherMoney2F.pplblAidInfoNoGetText(Sender: TObject;
var Text: String);
begin
  inherited;
...
procedure TGetOtherMoney2F.plblCmbPayTypesGetText(Sender: TObject;
var Text: string);
begin
  inherited;
...
procedure TGetOtherMoney2F.plblCmbTopicTypesGetText(Sender: TObject;
var Text: string);
begin
  inherited;
...
procedure TGetOtherMoney2F.ppDBMemo2GetMemo(Sender: TObject; aLines: TStrings);
begin
  inherited;
  if pnlPay_Topic.Visible then
...
procedure TGetOtherMoney2F.ppLblFormFoterGetText(Sender: TObject;
var Text: String);
begin
  inherited;
...
procedure TGetOtherMoney2F.EdtFNumEnter(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.qryFormsFormStateGetText(Sender: TField;
...
procedure TGetOtherMoney2F.qryFormsPayTypesChange(Sender: TField);
begin
  inherited;
...
procedure TGetOtherMoney2F.qryFormsBeforeEdit(DataSet: TDataSet);
var
  b: Boolean;
begin
  inherited;
...
function TGetOtherMoney2F.ReMainPerson(NewReMain: Currency = 0): Currency;
begin
  Result := NewReMain;
...
procedure TGetOtherMoney2F.qryFormsAfterEdit(DataSet: TDataSet);
begin
  inherited;
  DataSet.FieldByName('LastUser').AsString := user.name;
end;

procedure TGetOtherMoney2F.ProcHow2DisplayArzTypeID;
var
  b: Boolean;
begin
...
procedure TGetOtherMoney2F.qryFormsAfterScroll(DataSet: TDataSet);
begin
  inherited;
...
procedure TGetOtherMoney2F.ppLblState2ZeroDrawCommandCreate(Sender,
  aDrawCommand: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.ppLblState2ZeroDrawCommandClick(Sender,
  aDrawCommand: TObject);
begin
  inherited;
  (Sender As TppLabel).Visible := qryForms.FieldByName('FormState')
...
procedure TGetOtherMoney2F.ppLblState2ZeroGetText(Sender: TObject;
var Text: String);
begin
  inherited;
  (Sender As TppLabel).Visible := qryForms.FieldByName('FormState')
...
procedure TGetOtherMoney2F.ppLblState2ZeroPrint(Sender: TObject);
begin
  inherited;
  (Sender As TppLabel).Visible := qryForms.FieldByName('FormState')
    .AsInteger = 10;
...
procedure TGetOtherMoney2F.actSearchReprotExecute(Sender: TObject);
begin
  inherited;
  searchReportsF.Show(ppReport1, 'cash', Self);
end;

procedure TGetOtherMoney2F.actshowRelatedFExecute(Sender: TObject);
begin
  inherited;
  RelatedF.showRelatedF(qryForms, qryFormsCustomerID2.AsInteger);
end;

procedure TGetOtherMoney2F.DBEdit4KeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.qryFormsBeforeInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TGetOtherMoney2F.actCorrelateFormTypeExecute(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.actcustomerinterExecute(Sender: TObject);
begin
  inherited;
  mdiMainf.actCustomersInterView.Execute
end;

procedure TGetOtherMoney2F.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.actFilterExecute(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.UpdateList;
begin
  with qryAllForms Do
  begin
    Active := False;
...
procedure TGetOtherMoney2F.NAllRecordsClick(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.FormShow(Sender: TObject);
begin
  inherited;
  AccChangeNames(Self);
...
procedure TGetOtherMoney2F.actInserNoteExecute(Sender: TObject);
begin
  inherited;
  AddPopupMenu4Note(qryFormsFomNote);
end;

procedure TGetOtherMoney2F.actMakeDocumentShowExecute(Sender: TObject);
begin
  inherited;
  MakeDocumentShow(qryForms, qryInit);
end;

procedure TGetOtherMoney2F.actSmsSendExecute(Sender: TObject);
begin
  inherited;
  SmsSendQry(qryForms, nil, smsForms, formType, 0, 1);
end;

procedure TGetOtherMoney2F.actStateChangeExecute(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.actViewFileFExecute(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.actWorkflowHistoryFExecute(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.actRequestCashExecute(Sender: TObject);
begin
  inherited;
  RequestCashF.enter(qryForms)
end;

procedure TGetOtherMoney2F.actRptCofferExecute(Sender: TObject);
begin
  inherited;
  RptCofferF.enter(qryForms)
end;

procedure TGetOtherMoney2F.qryFormsFormDateChange(Sender: TField);
begin
  inherited;
  // FormDateChange(qryForms)
end;

procedure TGetOtherMoney2F.btnChangeTypeClick(Sender: TObject);
begin
  inherited;
  popChangeType.Popup(Mouse.CursorPos.X, Mouse.CursorPos.Y)
end;

procedure TGetOtherMoney2F.btnCustomerID3Click(Sender: TObject);
var
  txt: String;
  b: Boolean;
  Results: array [0 .. 3] of String;
...
procedure TGetOtherMoney2F.edtCustomerID3KeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.edtCustomerID4KeyDown(Sender: TObject; var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if Key = 32 then
...
procedure TGetOtherMoney2F.actGetExcelExecute(Sender: TObject);
begin
  inherited;
  try
    ShowImPortExcelon := True;
...
procedure TGetOtherMoney2F.qryFormsSellsEmporiumChange(Sender: TField);
begin
  inherited;
...
procedure TGetOtherMoney2F.qryFormsTopicCodeChange(Sender: TField);
begin
  inherited;
  Sender.Tag := StrToInt64(Trim(Sender.AsString))
end;

procedure TGetOtherMoney2F.mnu4allClick(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.MnuChangeTypeClick(Sender: TObject);
var
  ID: Largeint;
...
procedure TGetOtherMoney2F.actCopyFormExecute(Sender: TObject);
begin
  inherited;
...
procedure TGetOtherMoney2F.plblArzTypeGetText(Sender: TObject;
var Text: string);
begin
  inherited;
...
procedure TGetOtherMoney2F.actPcPosFExecute(Sender: TObject);
begin
  inherited;
