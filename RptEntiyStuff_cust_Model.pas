...
type
  TRptEntiyStuff_cust_ModelF = class(Ttemplate2MDIF)
    ...
    qryEntityPersonID1: TIntegerField;
    qryEntityCustName: TStringField;
...
var
  RptEntiyStuff_cust_ModelF: TRptEntiyStuff_cust_ModelF;
...
procedure TRptEntiyStuff_cust_ModelF.UpdateFilter;
begin
...
procedure TRptEntiyStuff_cust_ModelF.actFilterExecute(Sender: TObject);
begin
  inherited;
...
procedure TRptEntiyStuff_cust_ModelF.qryStoreAfterScroll(DataSet: TDataSet);
begin
  inherited;
  With qryEntity do begin
    Active:=False;
...
procedure TRptEntiyStuff_cust_ModelF.FormShow(Sender: TObject);
begin
  inherited;
  myParams.Clear;
  actFilter.Execute;
...
procedure TRptEntiyStuff_cust_ModelF.SBtnStoreIDClick(Sender: TObject);
var
  c:  String;
begin
  inherited;
...
procedure TRptEntiyStuff_cust_ModelF.ppLabel11GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptEntiyStuff_cust_ModelF.ppLabel3GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text:=GetPrintDate;
...
procedure TRptEntiyStuff_cust_ModelF.ppSystemVariable1GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptEntiyStuff_cust_ModelF.FormResize(Sender: TObject);
begin
  inherited;
  SetColSize(DBGrid1,1,True);
end;

procedure TRptEntiyStuff_cust_ModelF.FormDestroy(Sender: TObject);
begin
  inherited;
  SaveColWidth(DBGrid1);
end;

procedure TRptEntiyStuff_cust_ModelF.actsendtoexelExecute(Sender: TObject);
begin
  inherited;
  SendToExcel(qryEntity);
end;

procedure TRptEntiyStuff_cust_ModelF.actPrintExecute(Sender: TObject);
begin
  inherited;
  ppReport1.Print;
end;

procedure TRptEntiyStuff_cust_ModelF.ppLabel16GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptEntiyStuff_cust_ModelF.actSearch_Execute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qryEntity);
end;

procedure TRptEntiyStuff_cust_ModelF.actSortExecute(Sender: TObject);
begin
  inherited;
  sort2F.ShowSort(qryEntity);
end;

procedure TRptEntiyStuff_cust_ModelF.FormCreate(Sender: TObject);
begin
  inherited;
  //mary
...
procedure TRptEntiyStuff_cust_ModelF.DBGrid1MouseUp(Sender: TObject;
...
procedure TRptEntiyStuff_cust_ModelF.qryEntityCalcFields(DataSet: TDataSet);
begin
  inherited;
  DataSet.FieldByName('_row').AsInteger:=IfThen(DataSet.RecNo<>-1,DataSet.RecNo,1);
end;

procedure TRptEntiyStuff_cust_ModelF.qryEntityAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TRptEntiyStuff_cust_ModelF.ppLabel1GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
