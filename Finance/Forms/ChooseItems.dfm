inherited ChooseItemsF: TChooseItemsF
  Left = 341
  Top = 148
  ...
  object cliItems: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DataSetProvider1'
    Left = 40
    Top = 200
    object cliItems_checked: TBooleanField
      DisplayLabel = #1575#1606#1578#1582#1575#1576
      FieldKind = fkInternalCalc
      FieldName = '_checked'
    end
    object cliItemscode: TSmallintField
      Tag = 3
      FieldName = 'code'
    end
    object cliItemscaption: TStringField
      Tag = 3
    ...
    object cliItemscaption_l2: TStringField
      Tag = 3
