inherited CToplic2_RelationF: TCToplic2_RelationF
  Left = 541
  Top = 96
  ...
  object qryCTpTogether: TADOQuery
    Connection = DmF.adcAccounting
    CursorType = ctStatic
    ...
    SQL.Strings = (
      'SELECT *  FROM  acc.CTopicRangeTogether'
      'WHERE     (CTopicCode = :FilterCode)')
    Left = 408
    Top = 152
    object qryCTpTogetherCTopicCode: TIntegerField
      FieldName = 'CTopicCode'
    end
    object qryCTpTogetherCTopicCode2: TIntegerField
      FieldName = 'CTopicCode2'
    end
  end
end
