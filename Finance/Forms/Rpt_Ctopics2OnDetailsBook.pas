unit Rpt_Ctopics2OnDetailsBook;
...
type
  TRpt_Ctopics2OnDetailsBookF = class(Ttemplate2MDIF)
    qry_Doc: TADOQuery;
...
var
  Rpt_Ctopics2OnDetailsBookF: TRpt_Ctopics2OnDetailsBookF;
...
procedure TRpt_Ctopics2OnDetailsBookF.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.actFilterExecute(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.FormShow(Sender: TObject);
begin
  inherited;
  if showFilter then
  begin
...
procedure TRpt_Ctopics2OnDetailsBookF.qry_AccCodeAfterScroll(DataSet: TDataSet);
begin
  inherited;
  setVisibleColumns;
  with qry_Doc do
...
procedure TRpt_Ctopics2OnDetailsBookF.qry_CompaniesAfterScroll
  (DataSet: TDataSet);
var
...
procedure TRpt_Ctopics2OnDetailsBookF.qry_DocAfterOpen(DataSet: TDataSet);
begin
  inherited;
  DBGridCurrencyKind(DBGrid1, MyParams,qry_Doc)
end;

procedure TRpt_Ctopics2OnDetailsBookF.FormDestroy(Sender: TObject);
begin
  inherited;
//  cloned.Free;
...
procedure TRpt_Ctopics2OnDetailsBookF.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
  actShowForm.Execute
end;

procedure TRpt_Ctopics2OnDetailsBookF.InitForm;
begin
  PnlCompany.Visible := gv_MultiCompany and opta.ActivePartCompany;
  // mGrid1.SumCurrentRecord := opta.SumBook;
end;

procedure TRpt_Ctopics2OnDetailsBookF.UpdateFilter;
begin
  with qry_AccCode do
  begin
    Active := false;
...
//procedure TRpt_Ctopics2OnDetailsBookF.Updateremain;
//var
//  c, bes, bed: Currency;
//  amount, i: integer;
//begin
...
procedure TRpt_Ctopics2OnDetailsBookF.BitBtn1Click(Sender: TObject);
var
  s: boolean;
...
procedure TRpt_Ctopics2OnDetailsBookF.BitBtn2Click(Sender: TObject);
var
  s: boolean;
  Results: array [0 .. 2] of String;
  Txt: String;
...
procedure TRpt_Ctopics2OnDetailsBookF.actShowFormExecute(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.actSendExcelExecute(Sender: TObject);
begin
  inherited;
  SendToExcel(DBGrid1);
end;

procedure TRpt_Ctopics2OnDetailsBookF.actSearch_Execute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qry_Doc);
end;

procedure TRpt_Ctopics2OnDetailsBookF.actSortExecute(Sender: TObject);
begin
  inherited;
  sort2F.ShowSort(qry_Doc);
end;

procedure TRpt_Ctopics2OnDetailsBookF.DBGrid1KeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.ppLblSeconNo_DocNoGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := 'از شماره موقت ' +
...
procedure TRpt_Ctopics2OnDetailsBookF.ppLabel4GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := 'از شماره سند ' +
...
procedure TRpt_Ctopics2OnDetailsBookF.ppLblDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.ppLblCompanyNameGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.ppLblPrintDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := GetPrintDate;
...
procedure TRpt_Ctopics2OnDetailsBookF.ppSysVarPageNoGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.myInitReportFile(ReportName: TppReport;
...
procedure TRpt_Ctopics2OnDetailsBookF.N11Click(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.N2Click(Sender: TObject);
begin
  inherited;
  try
    qry_Companies.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.N3Click(Sender: TObject);
begin
  inherited;
  try
    qry_Companies.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop2Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop_3Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop_1Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop_4Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop_2Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop_5Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop_6Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop_8Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.pop_7Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnDetailsBookF.actPrintExecute(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.setVisibleColumns;
var
  id: integer;
begin
  inherited;
...
procedure TRpt_Ctopics2OnDetailsBookF.actVjPrintExecute(Sender: TObject);
begin
  inherited;
  DBGrid2PrintF.showGrid2Print(DBGrid1, 0);
end;

procedure TRpt_Ctopics2OnDetailsBookF.ppDBCalcnum2alphabetGetText
