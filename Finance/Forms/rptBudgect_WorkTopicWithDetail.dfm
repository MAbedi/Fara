inherited rptBudgect_WorkTopicWithDetailF: TrptBudgect_WorkTopicWithDetailF
  Left = 171
  Top = 116
  Caption = #1605#1602#1575#1610#1587#1607' '#1576#1608#1583#1580#1607' '#1608' '#1593#1605#1604#1603#1585#1583' - '#1583#1585#1587#1591#1581' '#1578#1601#1589#1610#1604#1610' '
  ClientHeight = 517
  OnResize = FormResize
  ExplicitWidth = 794
  TextHeight = 13
  ...
  object qryBudgect: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Acc.Documents.TopicCode, Acc.Details.DetailCode, Acc.Deta' +
        'ils.DetailName_L1,'
      
        '                    ABS(SUM(CASE WHEN Acc.DocGroups.CompanyCode ' +
        '= 99 THEN Acc.Documents.Debt - Acc.Documents.Credit ELSE 0 END))' +
        ' AS BudgetBalance,'
      
        #9'    ABS(SUM(CASE WHEN Acc.DocGroups.CompanyCode <> 99 THEN Acc.' +
        'Documents.Debt - Acc.Documents.Credit ELSE 0 END)) AS AccBalance' +
        ', '
        ...
        #9'    ABS(SUM(CASE WHEN Acc.DocGroups.CompanyCode <> 99 THEN Acc.' +
        'Documents.Debt - Acc.Documents.Credit ELSE 0 END)) AS Remain'
      'FROM  Acc.Documents INNER JOIN'
      
        '          Acc.Details ON Acc.Documents.DetailCode = Acc.Details.' +
        'DetailCode INNER JOIN'
      
        '          Acc.DocGroups ON Acc.Documents.Serial = Acc.DocGroups.' +
        'Serial AND Acc.Documents.CompanyCode = Acc.DocGroups.CompanyCode' +
        ' AND '
      '          Acc.Documents.YearID = Acc.DocGroups.YearID'
      
        'WHERE (Acc.Documents.TopicCode BETWEEN :TopicCodeFrom AND :Topic' +
        'CodeTo) '
      
        '           AND (Acc.DocGroups.DocDate BETWEEN :DateFrom AND :Dat' +
        'eTo)'
      
        '           AND (Acc.Details.DetailCode BETWEEN :DetailCodeFrom A' +
        'ND :DetailCodeTo)'
      '           AND (Acc.DocGroups.YearID = :YearId)'
      
        'GROUP BY Acc.Documents.TopicCode, Acc.Details.DetailCode, Acc.De' +
        'tails.DetailName_L1'
      'ORDER BY Acc.Documents.TopicCode')
    Left = 40
    Top = 77
    object lrgntfldBudgectTopicCode: TLargeintField
      DisplayLabel = #1705#1583#1605#1593#1740#1606
      FieldName = 'TopicCode'
    end
    object intgrfldBudgectDetailCode: TIntegerField
      DisplayLabel = #1578#1601#1589#1740#1604#1740
      FieldName = 'DetailCode'
    end
    object qryBudgectDetailName_L1: TStringField
      DisplayLabel = #1593#1606#1608#1575#1606' '#1581#1587#1575#1576' '#1578#1601#1589#1740#1604#1740
      FieldName = 'DetailName_L1'
      Size = 150
    end
    object bcdfldBudgectBudgetBalance: TBCDField
      DisplayLabel = #1576#1608#1583#1580#1607' '#1605#1589#1608#1576
      FieldName = 'BudgetBalance'
      ReadOnly = True
      Precision = 19
    end
    object bcdfldBudgectAccBalance: TBCDField
      DisplayLabel = #1593#1605#1604#1705#1585#1583
      FieldName = 'AccBalance'
      ReadOnly = True
      Precision = 19
    end
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\projects\Fara\Saman\exe\Report\rptBudgect_WorkTopicDetail.rtm'
    ...
    object ppFooterBand1: TppFooterBand
      ...
      object ppLabel4: TppLabel
        ...
        UserName = 'Label4'
        Border.mmPadding = 0
        Caption = #1580#1605#1593' '#1608#1606#1602#1604' '#1575#1586' '#1589#1601#1581#1607
        Font.Charset = ARABIC_CHARSET
        Font.Color = clBlack
        Font.Name = 'Yagut'
        Font.Size = 9
