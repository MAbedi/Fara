// RptTrialBalance_CTopics2_CTopicsاین فرم از
// کپی شده و امکان داره بعضی از اسامی به اون فرم مربوط باشه
// مصطفی فیض آبادی 1396/07/20
unit RptTrialBalance_CTopics3_CTopics;
...
type
  TRptTrialBalance_CTopics3_CTopicsF = class(Ttemplate2MDIF)
    ...
    qry_TrialCTopic2Balancectopiccode3: TIntegerField;
    ...
    procedure qry_TrialCTopic2BalanceAfterScroll(DataSet: TDataSet);
...
var
  RptTrialBalance_CTopics3_CTopicsF: TRptTrialBalance_CTopics3_CTopicsF;
  cloned: TADOQuery;
...
uses FilterClass_ADO, filter_ADO, GlobalPro, Dm, search2, sort2,
  ...
  Rpt_Ctopics3OnDetailsBook;

{$R *.dfm}

procedure TRptTrialBalance_CTopics3_CTopicsF.FormShow(Sender: TObject);
begin
  inherited;
  if ShowFilter then
  begin
...
procedure TRptTrialBalance_CTopics3_CTopicsF.actFilterExecute(Sender: TObject);
var
...
procedure TRptTrialBalance_CTopics3_CTopicsF.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.UpdateFilter;
begin
...
procedure TRptTrialBalance_CTopics3_CTopicsF.qry_TrialCTopic2BalanceAfterOpen
  (DataSet: TDataSet);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.actSearch_Execute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qry_TrialCTopic2Balance);
end;

procedure TRptTrialBalance_CTopics3_CTopicsF.actSendExeclExecute
  (Sender: TObject);
begin
  inherited;
  SendToExcel(DBGrid1);
...
procedure TRptTrialBalance_CTopics3_CTopicsF.actShowFormExecute
  (Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.qry_TrialCTopic2BalanceAfterScroll
  (DataSet: TDataSet);
begin
  inherited;
  ...
  // CurrToStrF(qrySumCTopic2.Fieldbyname('sumBalanceCredit').AsCurrency,
  // ffCurrency, 0);
  // StatusBar4.Panels[1].Text := 'بد=' +
  // CurrToStrF(qrySumCTopic2.Fieldbyname('sumBalanceDebt').AsCurrency,
  // ffCurrency, 0);
  // StatusBar4.Panels[2].Text := 'بس=' +
  // CurrToStrF(qrySumCTopic2.Fieldbyname('sumCredit').AsCurrency,
  // ffCurrency, 0);
  // StatusBar4.Panels[3].Text := 'بد=' +
  // CurrToStrF(qrySumCTopic2.Fieldbyname('sumDebt').AsCurrency,
  // ffCurrency, 0);
  // StatusBar4.Panels[4].Text := qry_TrialCTopic2Balance.Fieldbyname
  // ('MoeenName_L1').AsString;

end;

procedure TRptTrialBalance_CTopics3_CTopicsF.actUpdateExecute(Sender: TObject);
begin
  inherited;
  qry_TrialCTopic2Balance.Requery();
end;

procedure TRptTrialBalance_CTopics3_CTopicsF.actPrintExecute(Sender: TObject);
begin
  inherited;
  try
...
procedure TRptTrialBalance_CTopics3_CTopicsF.MenuItem2Click(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.MenuItem1Click(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.MenuItem3Click(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.MenuItem4Click(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.ppDBText4GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.ppDocDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := GetPrintDate;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.ppSystemVariable2GetText
...
procedure TRptTrialBalance_CTopics3_CTopicsF.ppLBCompanyNameGetText
  (Sender: TObject; var Text: String);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.ppLabel13GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.ppLabel12GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.DBGrid1KeyUp(Sender: TObject;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
  actShowForm.Execute;
end;

procedure TRptTrialBalance_CTopics3_CTopicsF.DBGrid1KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
...
//
//
procedure TRptTrialBalance_CTopics3_CTopicsF.N3Click(Sender: TObject);
begin
  inherited;
  UpdateAllQry(Self);
end;
...
procedure TRptTrialBalance_CTopics3_CTopicsF.actOtherExecute(Sender: TObject);
begin
  inherited;
