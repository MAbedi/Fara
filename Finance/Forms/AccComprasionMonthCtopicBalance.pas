unit AccComprasionMonthCtopicBalance;
...
type
  TAccComprasionMonthCtopicBalanceF = class(Ttemplate2MDIF)
    DBGrid1: TDBGrid;
    BitBtn2: TBitBtn;
    ...
    qryComprationCTopicCTopicCode: TIntegerField;
    qryComprationCTopicCTopicName_L1: TStringField;
    qryComprationCTopicCTopicName_L2: TStringField;
    BitBtn4: TBitBtn;
    actOther: TAction;
    popOther: TPopupMenu;
    MenuItem3: TMenuItem;
...
var
  AccComprasionMonthCtopicBalanceF: TAccComprasionMonthCtopicBalanceF;
...
procedure TAccComprasionMonthCtopicBalanceF.UpdateFilter;
// var
// ts:TStringList;
// s:String;
// i:Integer;
...
procedure TAccComprasionMonthCtopicBalanceF.actFilterExecute(Sender: TObject);
begin
  inherited;
...
procedure TAccComprasionMonthCtopicBalanceF.FormCreate(Sender: TObject);
begin
  inherited;
  ShowFilter := var_glb_Boolean;
end;

procedure TAccComprasionMonthCtopicBalanceF.FormShow(Sender: TObject);
begin
  inherited;
  if ShowFilter then
  begin
...
procedure TAccComprasionMonthCtopicBalanceF.DBGrid1DrawColumnCell
...
procedure TAccComprasionMonthCtopicBalanceF.ShowBeforeAccCode(LevelID: Integer);
begin
  ...
  Begin
    ...
    begin
      ...
      Parameters.ParamByName('CTopicCodeFrom').Value :=
        qryComprationCTopic.Parameters.ParamByName('CTopicCodeFrom').Value;
      Parameters.ParamByName('CTopicCodeTo').Value :=
        qryComprationCTopic.Parameters.ParamByName('CTopicCodeTo').Value;
      Parameters.ParamByName('FromYearID').Value := APPBank.Year;
      Parameters.ParamByName('ToYearID').Value := APPBank.Year;
...
procedure TAccComprasionMonthCtopicBalanceF.actBeforeLevelExecute
  (Sender: TObject);
var
  LevelID: Integer;
begin
...
procedure TAccComprasionMonthCtopicBalanceF.FormDestroy(Sender: TObject);
begin
  inherited;
  SaveColWidth(DBGrid1);
end;

procedure TAccComprasionMonthCtopicBalanceF.FormResize(Sender: TObject);
begin
  inherited;
  SetColSize(DBGrid1, 1, True);
end;

procedure TAccComprasionMonthCtopicBalanceF.actSortExecute(Sender: TObject);
begin
  inherited;
  sort2F.ShowSort(qryComprationCTopic);
end;

procedure TAccComprasionMonthCtopicBalanceF.actExcelExecute(Sender: TObject);
begin
  inherited;
  SendToExcel(DBGrid1);
end;

procedure TAccComprasionMonthCtopicBalanceF._actSearchExecute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qryComprationCTopic);
end;

procedure TAccComprasionMonthCtopicBalanceF.actOtherExecute(Sender: TObject);
begin
  inherited;
  popOther.Popup(Mouse.CursorPos.X, Mouse.CursorPos.Y);
end;

procedure TAccComprasionMonthCtopicBalanceF.actPrintExecute(Sender: TObject);
begin
  inherited;
  try
...
procedure TAccComprasionMonthCtopicBalanceF.MenuItem3Click(Sender: TObject);
begin
  inherited;
  DBGrid2PrintF.showGrid2Print(DBGrid1, 0);
end;

procedure TAccComprasionMonthCtopicBalanceF.MenuItem5Click(Sender: TObject);
begin
  inherited;
  UpdateAllQry(Self);
end;

procedure TAccComprasionMonthCtopicBalanceF.ppLblPrintDateGetText
  (Sender: TObject; var Text: String);
begin
  Text := GetPrintDate;
end;

procedure TAccComprasionMonthCtopicBalanceF.ppSysVarPageNoGetText
  (Sender: TObject; var Text: String);
begin
  Text := GetPageNumberString(Text)
end;

procedure TAccComprasionMonthCtopicBalanceF.ppLblCaptionGetText(Sender: TObject;
  var Text: String);
begin
  Text := Caption;
end;

procedure TAccComprasionMonthCtopicBalanceF.ppLblCompanyNameGetText
  (Sender: TObject; var Text: String);
begin
