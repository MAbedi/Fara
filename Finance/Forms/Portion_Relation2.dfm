inherited Portion_Relation2F: TPortion_Relation2F
  Left = 314
  Top = 192
  ...
  object qry_CToplic2: TADOQuery
    ...
    SQL.Strings = (
      ...
      'FROM         acc.CTopics2ForUse RIGHT OUTER JOIN'
      '                      acc.CenterTopics2 INNER JOIN'
      
        '                      acc.CTopicRangeTogether ON acc.CenterTopic' +
        's2.CTopicCode2 = acc.CTopicRangeTogether.CTopicCode2 ON '
      
        '                      acc.CTopics2ForUse.PrvTopicCode = acc.Cent' +
        'erTopics2.CTopicCode2'
      
        'WHERE     (acc.CTopics2ForUse.PrvTopicCode IS NULL)and (acc.Cent' +
        'erTopics2.CTopicCode2<>0)'
      'and   acc.CTopicRangeTogether.CTopicCode=:CTopicCode')
    Left = 24
    Top = 96
  end
  ...
  object cli_CToplic2: TClientDataSet
    ...
    object cli_CToplic2CTopicCode: TIntegerField
      DisplayLabel = #1603#1583
      DisplayWidth = 12
      FieldName = 'CTopicCode2'
    end
    object cli_CToplic2CTopicName_L1: TStringField
      DisplayLabel = #1593#1606#1608#1575#1606' '#1578#1601#1589#1610#1604#1610'2'
      FieldName = 'CTopicName2_L1'
      Size = 120
    end
    object cli_CToplic2CTopicName_L2: TStringField
  ...
  object qry_Portion: TADOQuery
    ...
    SQL.Strings = (
      ...
      'WHERE    CofficientID=:CofficientID')
    Left = 408
    Top = 152
