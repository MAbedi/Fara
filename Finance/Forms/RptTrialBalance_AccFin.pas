...
uses
  ...
  Buttons, DB, ADODB, ppBands, ppCtrls, ppPrnabl, ppClass, Filter_ADO_Const,
  ppDB, ppCache, ppProd, ppReport, ppComm, ppRelatv, ppDBPipe,AccFunctions,
  DBCtrls, Menus, ppVar, SumDBGrid, ppParameter, ppDesignLayer,
  System.ImageList, System.Actions, DBGridEhGrouping, ToolCtrlsEh,
  DBGridEhToolCtrls, DynVarsEh, EhLibVCL, GridsEh, DBAxisGridsEh, DBGridEh,
  CedarDbGrid;

type
  TRptTrialBalance_AccFinF = class(Ttemplate2MDIF)
    qry_Init: TADOQuery;
...
var
  RptTrialBalance_AccFinF: TRptTrialBalance_AccFinF;
  cloned: TADOQuery;
...
uses Dm, searchCode_ADO, filter_ADO, FilterClass_ADO, GlobalPro,
  ...
  RptTrialBalance_AccCode_Arzi, RptTrialBalance_CTopics3;

{$R *.dfm}
{ TRptTrialBalance_AccFinF }

procedure TRptTrialBalance_AccFinF.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.FormShow(Sender: TObject);
begin
  inherited;
  if ShowFilter then
  begin
...
procedure TRptTrialBalance_AccFinF.actFilterExecute(Sender: TObject);
var
...
procedure TRptTrialBalance_AccFinF.InitForm;
begin
  with qry_Init do
  Begin
    Active := False;
...
procedure TRptTrialBalance_AccFinF.FormPaint(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.actPrintExecute(Sender: TObject);
begin
  inherited;
  if formtype = 1 then
  begin
...
procedure TRptTrialBalance_AccFinF.actSendExeclExecute(Sender: TObject);
begin
  inherited;
  SendToExcel(DBGrid1);
end;

procedure TRptTrialBalance_AccFinF.actSearch_Execute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qry_TrialBalance);
end;

procedure TRptTrialBalance_AccFinF.actSortExecute(Sender: TObject);
begin
  inherited;
  sort2F.ShowSort(qry_TrialBalance);
end;

procedure TRptTrialBalance_AccFinF.DBGrid1KeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.UpdateFilter;
// var
// ts:TStringList;
// s:String;
// i:Integer;
...
procedure TRptTrialBalance_AccFinF.actShowFormExecute(Sender: TObject);
begin
  inherited;
  // Call rpt_AccbookF
  ...
  CreateMDIForm3(False, TRpt_AccBookF, Rpt_AccBookF, RptTrialBalance_AccFinF,
    formtype);
...
procedure TRptTrialBalance_AccFinF.actAfterLevelExecute(Sender: TObject);
var
  // TopTopice:Currency;
...
procedure TRptTrialBalance_AccFinF.actBeforeLevelExecute(Sender: TObject);
var
  LevelID: integer;
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.ppLabel4GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.ppLabel5GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := GetPrintDate;
...
procedure TRptTrialBalance_AccFinF.mnuDetailClick(Sender: TObject);
var
  TopTopice: integer;
...
procedure TRptTrialBalance_AccFinF.mnuDetail_arziClick(Sender: TObject);
var
  TopTopice: integer;
  // PrvCodeLength,CodeLength:Integer;
  // s:string;
begin
  ...
  CreateMDIForm3(False, TRptTrialBalance_AccCode_ArziF,
    RptTrialBalance_AccCode_ArziF, RptTrialBalance_AccFinF, formtype);
  // ------------------SET Parameters in  TRptTrialBalance_DetailsF  form
...
procedure TRptTrialBalance_AccFinF.mnuCtopic1Click(Sender: TObject);
var
  TopTopice: integer;
  // CodeLength:Integer;
...
procedure TRptTrialBalance_AccFinF.actUpdateExecute(Sender: TObject);
begin
  inherited;
  qry_TrialBalance.Requery();
end;

procedure TRptTrialBalance_AccFinF.qry_TrialBalanceAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.ppLBCompanyNameGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := APPBank.CompanyName;
...
procedure TRptTrialBalance_AccFinF.ppDocDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := GetPrintDate;
...
procedure TRptTrialBalance_AccFinF.ppSystemVariable2GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.ppLabel13GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.ppLabel12GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.MenuItem2Click(Sender: TObject);
begin
  inherited;
  try
    qry_TrialBalance.DisableControls;
    InitReportFile(ppReport1, 'RepRptTrialBalance_AccFin', DBGrid1,
      ppDBPipeline1);
  finally
...
procedure TRptTrialBalance_AccFinF.MenuItem1Click(Sender: TObject);
begin
  inherited;
  try
    qry_TrialBalance.DisableControls;
    InitReportFile(ppReport1, 'RepRptTrialBalance_AccFin_Topic', DBGrid1,
      ppDBPipeline1);
  finally
    qry_TrialBalance.EnableControls;
  end;
...
procedure TRptTrialBalance_AccFinF.ppLabel3GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  case formtype of
...
procedure TRptTrialBalance_AccFinF.MenuItem4Click(Sender: TObject);
begin
  inherited;
  try
    qry_TrialBalance.DisableControls;
    InitReportFile(ppReport1, 'RepRptTrialBalance_AccFin_L', DBGrid1,
      ppDBPipeline1);
  finally
    qry_TrialBalance.EnableControls;
  end;
...
procedure TRptTrialBalance_AccFinF.MenuItem3Click(Sender: TObject);
begin
  inherited;
  try
    qry_TrialBalance.DisableControls;
    InitReportFile(ppReport1, 'RepRptTrialBalance_AccFin_Topic_L', DBGrid1,
      ppDBPipeline1);
  finally
    qry_TrialBalance.EnableControls;
  end;
...
procedure TRptTrialBalance_AccFinF.mnuCtopic2Click(Sender: TObject);
var
  TopTopice: integer;
  // CodeLength:Integer;
begin
...
procedure TRptTrialBalance_AccFinF.mnuCtopic3Click(Sender: TObject);
var
  TopTopice: integer;
  // CodeLength:Integer;
begin
...
procedure TRptTrialBalance_AccFinF.ShowBeforeAccCode(LevelID: integer);
var
  AccCode: integer;
begin
  CreateMDIForm3(False, TRptTrialBalance_AccFinF, RptTrialBalance_AccFinF,
    Self, LevelID);
  ...
  with RptTrialBalance_AccFinF do
  Begin
    with qry_TrialBalance do
    begin
      Active := False;
    ...
    // end;
  end; // with_RptTrialBalance_AccFinF
end;

procedure TRptTrialBalance_AccFinF.ShowAfterAccCode(prvLevelID, CodeLength,
  PrvCodeLength: integer);
begin
  CreateMDIForm3(False, TRptTrialBalance_AccFinF, RptTrialBalance_AccFinF, Self,
    prvLevelID);
  with RptTrialBalance_AccFinF do
  Begin
    with qry_TrialBalance do
  ...
  end; // with_RptTrialBalance_AccFin2F

end;

procedure TRptTrialBalance_AccFinF.N10Click(Sender: TObject);
begin
  inherited;
  try
    qry_TrialBalance.DisableControls;
    InitReportFile(ppReport1, 'RepRptTrialBalance_AccFin_Topic_Currency', DBGrid1,
      ppDBPipeline1);
  finally
    qry_TrialBalance.EnableControls;
  end;
...
procedure TRptTrialBalance_AccFinF.N1Click(Sender: TObject);
begin
  inherited;
  DBGrid2PrintF.showGrid2Print(DBGrid1, 0, LblShowLimitPlace1.Caption);
end;

procedure TRptTrialBalance_AccFinF.N2Click(Sender: TObject);
begin
  inherited;
  TreeChartF.showChart(qry_TrialBalance, Self);
end;

procedure TRptTrialBalance_AccFinF.N3Click(Sender: TObject);
begin
  inherited;
  UpdateAllQry(Self);
end;

procedure TRptTrialBalance_AccFinF.actOtherExecute(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.N4Click(Sender: TObject);
begin
  inherited;
...
procedure TRptTrialBalance_AccFinF.N5Click(Sender: TObject);
var
  txt: String;
...
procedure TRptTrialBalance_AccFinF.N9Click(Sender: TObject);
begin
  inherited;
  try
    qry_TrialBalance.DisableControls;
    InitReportFile(ppReport1, 'RepRptTrialBalance_AccFin_Topic_AllCurrency', DBGrid1,
      ppDBPipeline1);
  finally
    qry_TrialBalance.EnableControls;
  end;
