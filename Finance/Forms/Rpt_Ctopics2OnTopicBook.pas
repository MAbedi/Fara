...
var
  Rpt_Ctopics2OnTopicBookF: TRpt_Ctopics2OnTopicBookF;
...
procedure TRpt_Ctopics2OnTopicBookF.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.actFilterExecute(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.FormShow(Sender: TObject);
begin
  inherited;
  if showFilter then
  begin
...
procedure TRpt_Ctopics2OnTopicBookF.qry_AccCodeAfterScroll(DataSet: TDataSet);
begin
  inherited;
  setVisibleColumns;
  with qry_Doc do
...
procedure TRpt_Ctopics2OnTopicBookF.qry_CompaniesAfterScroll(DataSet: TDataSet);
begin
  inherited;
  with qry_Doc do
  begin
...
procedure TRpt_Ctopics2OnTopicBookF.InitForm;
begin
...
procedure TRpt_Ctopics2OnTopicBookF.UpdateFilter;
// var
// ts:TStringList;
// i:Integer;
// s:string;
...
//procedure TRpt_Ctopics2OnTopicBookF.Updateremain;
//var
//  c, bes, bed: Currency;
//  amount, i: integer;
//begin
...
procedure TRpt_Ctopics2OnTopicBookF.ActShowFormExecute(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
  ActShowForm.Execute
end;

procedure TRpt_Ctopics2OnTopicBookF.actSortExecute(Sender: TObject);
begin
  inherited;
  sort2F.ShowSort(qry_Doc);
end;

procedure TRpt_Ctopics2OnTopicBookF.actSearch_Execute(Sender: TObject);
begin
  inherited;
  search2F.ShowSearch(qry_Doc);
end;

procedure TRpt_Ctopics2OnTopicBookF.actSendExcelExecute(Sender: TObject);
begin
  inherited;
  SendToExcel(DBGrid1);
end;

procedure TRpt_Ctopics2OnTopicBookF.BitBtn1Click(Sender: TObject);
var
  s: boolean;
...
procedure TRpt_Ctopics2OnTopicBookF.BitBtn2Click(Sender: TObject);
var
  s: boolean;
  Results: array [0 .. 2] of String;
  Txt: String;
begin
  inherited;
  Txt := 'select * from (SELECT Ltrim(Rtrim(Str(acc.Documents.CTopicCode2 )))+ '' - '' +Rtrim(ltrim(Str(acc.Documents.TopicCode))) AS AccCode,'
    + '  acc.Categories.MoeenName_L1+ '' - ''+acc.CenterTopics2.CTopicName2_L1 as AccName_L1'
    + ', acc.Categories.MoeenName_L2+ '' - ''+acc.CenterTopics2.CTopicName2_L2 as AccName_L2'
    + ' FROM   acc.Documents INNER JOIN ' +
    ' acc.DocGroups ON acc.Documents.Serial = acc.DocGroups.Serial INNER JOIN '
    + ' acc.CenterTopics2 ON acc.Documents.CTopicCode2 = acc.CenterTopics2.CTopicCode2 INNER JOIN '
  ...
  // ' and (acc.Documents.CTopicCode2 BETWEEN '+GetcFrom(myParams.ParamValues['CTopicCode2'],ftString)+' AND '+GetcTo(myParams.ParamValues['CTopicCode2'],ftString)+ ') '+
    ' GROUP BY acc.Documents.CTopicCode2, acc.CenterTopics2.CTopicName2_L1, acc.CenterTopics2.CTopicName2_L2,'
...
procedure TRpt_Ctopics2OnTopicBookF.DBGrid1KeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.qry_DocAfterOpen(DataSet: TDataSet);
begin
  inherited;
  DBGridCurrencyKind(DBGrid1, MyParams,qry_Doc)
end;

procedure TRpt_Ctopics2OnTopicBookF.qry_DocAfterScroll(DataSet: TDataSet);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.DBGrid1KeyDown(Sender: TObject;
...
procedure TRpt_Ctopics2OnTopicBookF.actPrintExecute(Sender: TObject);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.ppLblCompanyNameGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.ppSysVarPageNoGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.ppLblPrintDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := GetPrintDate;
...
procedure TRpt_Ctopics2OnTopicBookF.ppLblSeconNo_DocNoGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.ppLblDateGetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  With qry_Doc.Parameters do
...
procedure TRpt_Ctopics2OnTopicBookF.MenuItem1Click(Sender: TObject);
begin
  inherited;
  try
    ...
    ppLblRptName.Caption := 'دفتر حساب تفصیلی 3 در سطح حساب';
  finally
...
procedure TRpt_Ctopics2OnTopicBookF.MenuItem2Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.N2Click(Sender: TObject);
begin
  inherited;
  try
    qry_Companies.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.N3Click(Sender: TObject);
begin
  inherited;
  try
    qry_Companies.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.Pop_2Click(Sender: TObject);
begin
  inherited;
  try
    qry_Companies.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.pop_3Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.Pop_4Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.pop_5Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.pop_6Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.pop_7Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.pop_8Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.pop_1Click(Sender: TObject);
begin
  inherited;
  try
    qry_Doc.DisableControls;
...
procedure TRpt_Ctopics2OnTopicBookF.ppLabel11GetText(Sender: TObject;
  var Text: String);
begin
  inherited;
  Text := 'از شماره سند ' +
...
procedure TRpt_Ctopics2OnTopicBookF.setVisibleColumns;
var
  id: integer;
begin
  inherited;
...
procedure TRpt_Ctopics2OnTopicBookF.actVjPrintExecute(Sender: TObject);
begin
  inherited;
  DBGrid2PrintF.showGrid2Print(DBGrid1, 0);
end;

procedure TRpt_Ctopics2OnTopicBookF.ppDBCalcnum2alphabetGetText(Sender: TObject;
  var Text: string);
var
  c: Currency;
begin
