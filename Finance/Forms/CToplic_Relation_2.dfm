inherited CToplic_Relation_2F: TCToplic_Relation_2F
  Left = 314
  Top = 167
  Caption = #1575#1606#1578#1582#1575#1576' '#1603#1583#1607#1575#1610' '#1578#1601#1589#1610#1604#1610'3'
  ClientHeight = 371
  ClientWidth = 482
  OnResize = FormResize
  ExplicitWidth = 488
  ...
  object qry_CToplic2: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT  acc.CenterTopics.CTopicCode, acc.CenterTopics.CTopicName' +
        '_L1,'
      '        acc.CenterTopics.CTopicName_L2'
      'FROM    acc.CenterTopics LEFT OUTER JOIN'
      
        '        acc.CTopicsForUse ON acc.CenterTopics.CTopicCode = acc.C' +
        'TopicsForUse.PrvTopicCode'
      
        'WHERE   (acc.CTopicsForUse.PrvTopicCode IS NULL) and (acc.Center' +
        'Topics.CTopicCode<>0)'
      '')
    Left = 24
    Top = 96
    object qry_CToplic2CTopicCode: TIntegerField
      Tag = 3
      DisplayLabel = #1603#1583
      FieldName = 'CTopicCode'
    end
    object qry_CToplic2CTopicName_L1: TStringField
      Tag = 3
      DisplayLabel = #1593#1606#1608#1575#1606
      FieldName = 'CTopicName_L1'
      Size = 120
    end
    object qry_CToplic2CTopicName_L2: TStringField
      Tag = 3
